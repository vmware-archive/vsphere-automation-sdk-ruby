#---------------------------------------------------------------------------
# CHT cloudhealth/vsphere-automation-sdk-ruby 
# These helper methods are customized versions of the samples under vsphere-automation-sdk-6.5.
# 
# Authors : Erol Aygar
# Email : eaygar@cloudhealthtech.com
# Homepage: https://github.com/CloudHealth/vsphere-automation-sdk-ruby
#---------------------------------------------------------------------------
require 'optparse'
require 'logger'
...
module VSphere
	...
	class Base
	    ...
	    attr_accessor :ls_ip, :ls_url, :sso_username, :sso_password,
	                  :mgmt_node_index, :mgmt_node_id, :mgmt_node_name
	    ...
	    def get_service_manager(node_id=nil)
	        ...
	        return ServiceManager.get_instance(psc, node_id)
	    end
