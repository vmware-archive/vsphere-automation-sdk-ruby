...
module VSphereAutomation
  module ESX
  class SettingsHostsPoliciesApplyApi
    ...
    # @return [EsxSettingsHostsPoliciesApplyConfiguredPolicySpec|VapiStdErrorsUnauthenticated|VapiStdErrorsNotFound|VapiStdErrorsError|VapiStdErrorsServiceUnavailable|]
    def get(host, opts = {})
    ...
    # @param host The host identifier.
    # @param [Hash] opts the optional parameters
    # @return [Array<(EsxSettingsHostsPoliciesApplyConfiguredPolicySpec|VapiStdErrorsUnauthenticated|VapiStdErrorsNotFound|VapiStdErrorsError|VapiStdErrorsServiceUnavailable|, Fixnum, Hash)>]  data, response status code and response headers
    def get_with_http_info(host, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SettingsHostsPoliciesApplyApi.get ...'
      end
      # verify the required parameter 'host' is set
      if @api_client.config.client_side_validation && host.nil?
        fail ArgumentError, "Missing the required parameter 'host' when calling SettingsHostsPoliciesApplyApi.get"
      end
      # resource path
      local_var_path = '/api/esx/settings/hosts/{host}/policies/apply'.sub('{' + 'host' + '}', host.to_s)
	...
	:return_type => {
	  '200' => 'ESX::EsxSettingsHostsPoliciesApplyConfiguredPolicySpec',
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsHostsPoliciesApplyApi#get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def set_with_http_info(host, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SettingsHostsPoliciesApplyApi.set ...'
      end
      # verify the required parameter 'host' is set
      if @api_client.config.client_side_validation && host.nil?
        fail ArgumentError, "Missing the required parameter 'host' when calling SettingsHostsPoliciesApplyApi.set"
      end
      # resource path
      local_var_path = '/api/esx/settings/hosts/{host}/policies/apply'.sub('{' + 'host' + '}', host.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsHostsPoliciesApplyApi#set\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
