...
module VSphereAutomation
  module ESX
    class EsxSettingsDepotContentAddOnsAddOnVersionSummary
    ...
    def self.openapi_types
      {
        :'category' => :'EsxSettingsDepotContentAddOnsCategoryType',
    ...
    def hash
      [category, display_version, kb, release_date, summary, version].hash
    end
