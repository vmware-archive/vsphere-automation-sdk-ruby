...
module VSphereAutomation
  module ESX
    class EsxSettingsHostsSoftwareReportsApplyImpactHostImpact
    # Identifier of the commit on which the impact is generated. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    attr_accessor :commit

    attr_accessor :host_info

    # Impact of steps performed during the apply {@term operation}. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    ...
    def self.openapi_types
      {
        ...
        :'impact' => :'Array<EsxSettingsHostsSoftwareReportsApplyImpactImpact>'
      }
    end
