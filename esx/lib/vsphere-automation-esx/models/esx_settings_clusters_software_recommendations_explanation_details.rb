...
module VSphereAutomation
  module ESX
    class EsxSettingsClustersSoftwareRecommendationsExplanationDetails
    ...
    def self.openapi_types
      {
        ...
        :'explanation' => :'Array<VapiStdLocalizableMessage>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'explanation')
        if (value = attributes[:'explanation']).is_a?(Array)
    ...
    def hash
      [display_name, display_version, explanation].hash
    end
