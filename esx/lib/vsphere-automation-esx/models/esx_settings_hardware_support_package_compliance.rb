...
module VSphereAutomation
  module ESX
    class EsxSettingsHardwareSupportPackageCompliance
    ...
    attr_accessor :hardware_modules
    ...
    def self.openapi_types
      {
        :'current' => :'EsxSettingsHardwareSupportPackageInfo',
        :'hardware_modules' => :'Hash<String, EsxSettingsHardwareModuleFirmwareCompliance>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hardware_modules')
        if (value = attributes[:'hardware_modules']).is_a?(Hash)
          self.hardware_modules = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @hardware_modules.nil?
        invalid_properties.push('invalid value for "hardware_modules", hardware_modules cannot be nil.')
      end
    ...
    def valid?
      return false if @hardware_modules.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          current == o.current &&
          hardware_modules == o.hardware_modules &&
    ...
    def hash
      [current, hardware_modules, notifications, status, target].hash
    end
