...
module VSphereAutomation
  module ESX
    class EsxSettingsComponentCompliance
    ...
    def self.openapi_types
      {
        :'current' => :'EsxSettingsComponentInfo',
        :'current_source' => :'EsxSettingsComponentSource',
        :'notifications' => :'EsxSettingsNotifications',
        :'status' => :'EsxSettingsComplianceStatus',
        :'target' => :'EsxSettingsComponentInfo',
        :'target_source' => :'EsxSettingsComponentSource'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'current_source')
        self.current_source = attributes[:'current_source']
      end
      ...
      if attributes.has_key?(:'target_source')
        self.target_source = attributes[:'target_source']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          current == o.current &&
          current_source == o.current_source &&
    ...
    def hash
      [current, current_source, notifications, status, target, target_source].hash
    end
