...
module VSphereAutomation
  module ESX
    class EsxHclHostsCompatibilityReportSpec
    # A target ESXi release which will be used to generate a compatibility report. Releases that can be used to generate report can be found using {@link esx.hcl.hosts.CompatibilityReleases#list}
