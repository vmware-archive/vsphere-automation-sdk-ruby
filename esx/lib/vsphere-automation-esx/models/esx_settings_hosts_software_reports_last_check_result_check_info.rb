...
module VSphereAutomation
  module ESX
    class EsxSettingsHostsSoftwareReportsLastCheckResultCheckInfo
    # The check identifier. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    attr_accessor :check
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'VapiStdLocalizableMessage'
      }
    end
