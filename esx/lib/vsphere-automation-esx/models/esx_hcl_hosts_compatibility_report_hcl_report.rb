...
module VSphereAutomation
  module ESX
    ...
    def self.attribute_map
      {
        :'devices_hcl' => :'devices_hcl',
        :'generated_at' => :'generated_at',
        :'host' => :'host',
        :'notifications' => :'notifications',
        :'server_hcl' => :'server_hcl',
    ...
    def self.openapi_types
      {
        :'devices_hcl' => :'Array<EsxHclHostsCompatibilityReportDeviceHclInfo>',
        :'generated_at' => :'DateTime',
        :'host' => :'String',
        :'notifications' => :'EsxHclNotifications',
        :'server_hcl' => :'EsxHclHostsCompatibilityReportServerHclInfo',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'devices_hcl')
        if (value = attributes[:'devices_hcl']).is_a?(Array)
          self.devices_hcl = value
        end
      end
      ...
      if attributes.has_key?(:'server_hcl')
        self.server_hcl = attributes[:'server_hcl']
      end

      if attributes.has_key?(:'target_release')
        self.target_release = attributes[:'target_release']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @server_hcl.nil?
        invalid_properties.push('invalid value for "server_hcl", server_hcl cannot be nil.')
      end

      if @target_release.nil?
        invalid_properties.push('invalid value for "target_release", target_release cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @server_hcl.nil?
      return false if @target_release.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          devices_hcl == o.devices_hcl &&
          generated_at == o.generated_at &&
          host == o.host &&
          notifications == o.notifications &&
          server_hcl == o.server_hcl &&
          target_release == o.target_release
    end
    ...
    def hash
      [devices_hcl, generated_at, host, notifications, server_hcl, target_release].hash
    end
