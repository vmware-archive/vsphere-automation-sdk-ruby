...
module VSphereAutomation
  module ESX
    class EsxSettingsClustersSoftwareReportsLastCheckResultCheckResult
    ...
    def self.openapi_types
      {
        :'commit' => :'String',
        :'end_time' => :'DateTime',
        :'entity_results' => :'Array<EsxSettingsClustersSoftwareReportsLastCheckResultEntityCheckResult>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'entity_results')
        if (value = attributes[:'entity_results']).is_a?(Array)
          self.entity_results = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @entity_results.nil?
        invalid_properties.push('invalid value for "entity_results", entity_results cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @entity_results.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          commit == o.commit &&
          end_time == o.end_time &&
          entity_results == o.entity_results &&
    ...
    def hash
      [commit, end_time, entity_results, host_info, start_time, status].hash
    end
