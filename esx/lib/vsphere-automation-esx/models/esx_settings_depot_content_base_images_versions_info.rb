...
module VSphereAutomation
  module ESX
    class EsxSettingsDepotContentBaseImagesVersionsInfo
    ...
    def self.openapi_types
      {
        :'category' => :'EsxSettingsDepotContentBaseImagesVersionsCategoryType',
        :'components' => :'Array<EsxSettingsDepotContentBaseImagesVersionsComponentVersionInfo>',
        :'description' => :'String',
        :'display_name' => :'String',
    ...
    def hash
      [category, components, description, display_name, display_version, kb, release_date, summary, version].hash
    end
