...
module VSphereAutomation
  module ESX
    class EsxSettingsDepotsSyncScheduleSchedule
    ...
    # This determines the units of {@name Recurrence} to skip before the scheduled task runs again. For example, value of 1 for HOURLY type means the scheduled task runs every 2 hours. The value must be within the range 0 to 998.
    attr_accessor :skip
    ...
    def self.openapi_types
      {
        ...
        :'day_of_week' => :'EsxSettingsDepotsSyncScheduleDayOfWeek',
        :'hour' => :'Integer',
        :'minute' => :'Integer',
        :'skip' => :'Integer',
        :'type' => :'EsxSettingsDepotsSyncScheduleRecurrence'
      }
    end
    ...
    def hash
      [day_of_month, day_of_week, hour, minute, skip, type].hash
    end
