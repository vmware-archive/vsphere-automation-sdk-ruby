...
module VSphereAutomation
  module ESX
    class EsxSettingsHostsSoftwareReportsLastCheckResultCheckStatus
    attr_accessor :check

    # The issues encountered while running this check. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    ...
    def self.openapi_types
      {
        :'check' => :'EsxSettingsHostsSoftwareReportsLastCheckResultCheckInfo',
        :'issues' => :'Array<VapiStdLocalizableMessage>',
