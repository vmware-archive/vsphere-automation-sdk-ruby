...
module VSphereAutomation
  module ESX
    class EsxHealthPerspectivesCredentialsNsxConnectionSpec
    # The IP Address or FQDN of the NSX-T Manager.
    attr_accessor :hostname

    # Password for the passed user.
    ...
    def hash
      [hostname, password, ssl_thumbprint, username].hash
    end
