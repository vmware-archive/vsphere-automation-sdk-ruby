...
module VSphereAutomation
  module ESX
    class EsxSettingsDepotsSyncScheduleSpec
    ...
    def self.openapi_types
      {
        ...
        :'enabled' => :'Boolean',
        :'schedule' => :'EsxSettingsDepotsSyncScheduleSchedule'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'email_addresses')
    ...
    def hash
      [email_addresses, enabled, schedule].hash
    end
