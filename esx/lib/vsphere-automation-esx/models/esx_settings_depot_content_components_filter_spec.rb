...
module VSphereAutomation
  module ESX
    class EsxSettingsDepotContentComponentsFilterSpec
    # Component bundle types that a component must have to match the filter.
    attr_accessor :bundle_types
    ...
    def self.openapi_types
      {
        :'bundle_types' => :'Array<EsxSettingsDepotContentComponentsComponentBundleType>',
        :'min_version' => :'String',
        :'names' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bundle_types')
        if (value = attributes[:'bundle_types']).is_a?(Array)
          self.bundle_types = value
        end
      end
    ...
    def hash
      [bundle_types, min_version, names, vendors, versions].hash
    end
