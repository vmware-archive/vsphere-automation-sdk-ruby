...
module VSphereAutomation
  module ESX
    class EsxHclHostsCompatibilityReportResult
    # The identifier of the compatibility report. <p> {@link esx.hcl.Reports#get} provides location where a file based report based on the {@name HclReport} can be downloaded using this identifier.
    ...
    def self.openapi_types
      {
        :'identifier' => :'String',
        :'report' => :'EsxHclHostsCompatibilityReportHclReport'
      }
    end
