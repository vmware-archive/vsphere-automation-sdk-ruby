...
module VSphereAutomation
  module ESX
    class EsxSettingsHostsSoftwareDraftsInternalCreateResult
    # Identifier of the draft. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    attr_accessor :draft
    ...
    def self.openapi_types
      {
        :'draft' => :'String',
        :'info' => :'EsxSettingsHostsSoftwareDraftsInternalInfo'
      }
    end
