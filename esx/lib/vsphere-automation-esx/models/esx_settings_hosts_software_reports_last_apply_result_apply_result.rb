...
module VSphereAutomation
  module ESX
    class EsxSettingsHostsSoftwareReportsLastApplyResultApplyResult
    # The identifier of the commit used to fetch the desired software document to be applied to the standalone host. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    ...
    def self.openapi_types
      {
        ...
        :'status' => :'EsxSettingsHostsSoftwareReportsLastApplyResultApplyStatus'
      }
    end
