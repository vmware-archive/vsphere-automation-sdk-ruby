...
module VSphereAutomation
  module ESX
    class EsxSettingsHostsSoftwareDraftsFilterSpec
    # Owners of the drafts. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
