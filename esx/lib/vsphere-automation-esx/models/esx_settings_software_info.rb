...
module VSphereAutomation
  module ESX
    ...
    def self.openapi_types
      {
        :'add_on' => :'EsxSettingsAddOnInfo',
        :'base_image' => :'EsxSettingsBaseImageInfo',
        :'components' => :'Hash<String, EsxSettingsComponentInfo>',
        :'hardware_support' => :'EsxSettingsHardwareSupportInfo',
        :'solutions' => :'Hash<String, EsxSettingsSolutionInfo>'
      }
    end
