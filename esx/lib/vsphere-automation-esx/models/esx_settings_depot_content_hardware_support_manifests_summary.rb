...
module VSphereAutomation
  module ESX
    class EsxSettingsDepotContentHardwareSupportManifestsSummary
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'vendor' => :'String',
        :'versions' => :'Array<EsxSettingsDepotContentHardwareSupportManifestsManifestVersionSummary>'
      }
    end
    ...
    def hash
      [display_name, name, vendor, versions].hash
    end
