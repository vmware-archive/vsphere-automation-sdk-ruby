...
module VSphereAutomation
  module ESX
    class EsxSettingsHardwareModuleFirmwareCompliance
    ...
    def self.openapi_types
      {
        :'current' => :'EsxSettingsHardwareModuleFirmwareInfo',
        :'details' => :'EsxSettingsHardwareModuleDetails',
        :'notifications' => :'EsxSettingsNotifications',
        :'status' => :'EsxSettingsComplianceStatus',
        :'target' => :'EsxSettingsHardwareModuleFirmwareInfo'
      }
    end
    ...
    def hash
      [current, details, notifications, status, target].hash
    end
