...
module VSphereAutomation
  module ESX
    class EsxHealthCheckStatus
    attr_accessor :info

    # List of {@link vapi.std.LocalizableMessage} of issues that the check reported.
    ...
    def hash
      [info, issues, status, wait_duration].hash
    end
