...
# Unit tests for VSphereAutomation::ESX::VapiStdErrorsInvalidArgument
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VapiStdErrorsInvalidArgument' do
  before do
    # run before each test
    @instance = VSphereAutomation::ESX::VapiStdErrorsInvalidArgument.new
  end
  ...
  describe 'test an instance of VapiStdErrorsInvalidArgument' do
    it 'should create an instance of VapiStdErrorsInvalidArgument' do
      expect(@instance).to be_instance_of(VSphereAutomation::ESX::VapiStdErrorsInvalidArgument)
    end
  end
