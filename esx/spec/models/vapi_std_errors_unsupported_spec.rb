...
# Unit tests for VSphereAutomation::ESX::VapiStdErrorsUnsupported
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VapiStdErrorsUnsupported' do
  before do
    # run before each test
    @instance = VSphereAutomation::ESX::VapiStdErrorsUnsupported.new
  end
  ...
  describe 'test an instance of VapiStdErrorsUnsupported' do
    it 'should create an instance of VapiStdErrorsUnsupported' do
      expect(@instance).to be_instance_of(VSphereAutomation::ESX::VapiStdErrorsUnsupported)
    end
  end
