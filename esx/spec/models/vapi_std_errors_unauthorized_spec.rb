...
# Unit tests for VSphereAutomation::ESX::VapiStdErrorsUnauthorized
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VapiStdErrorsUnauthorized' do
  before do
    # run before each test
    @instance = VSphereAutomation::ESX::VapiStdErrorsUnauthorized.new
  end
  ...
  describe 'test an instance of VapiStdErrorsUnauthorized' do
    it 'should create an instance of VapiStdErrorsUnauthorized' do
      expect(@instance).to be_instance_of(VSphereAutomation::ESX::VapiStdErrorsUnauthorized)
    end
  end
