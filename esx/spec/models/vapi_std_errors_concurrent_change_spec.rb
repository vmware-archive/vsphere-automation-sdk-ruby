...
# Unit tests for VSphereAutomation::ESX::VapiStdErrorsConcurrentChange
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VapiStdErrorsConcurrentChange' do
  before do
    # run before each test
    @instance = VSphereAutomation::ESX::VapiStdErrorsConcurrentChange.new
  end
  ...
  describe 'test an instance of VapiStdErrorsConcurrentChange' do
    it 'should create an instance of VapiStdErrorsConcurrentChange' do
      expect(@instance).to be_instance_of(VSphereAutomation::ESX::VapiStdErrorsConcurrentChange)
    end
  end
