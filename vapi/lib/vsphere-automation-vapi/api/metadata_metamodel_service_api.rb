...
module VSphereAutomation
  ...
  class MetadataMetamodelServiceApi
    ...
    # @param service_id Identifier of the service element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelServiceResult, Fixnum, Hash)>] VapiMetadataMetamodelServiceResult data, response status code and response headers
    def get_with_http_info(service_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataMetamodelServiceResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the service elements that are currently registered with the infrastructure. &lt;p&gt; The list of service elements is an aggregate list of all the service elements contained in all the package elements.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelServiceListResult, Fixnum, Hash)>] VapiMetadataMetamodelServiceListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataMetamodelServiceListResult')
      if @api_client.config.debugging
