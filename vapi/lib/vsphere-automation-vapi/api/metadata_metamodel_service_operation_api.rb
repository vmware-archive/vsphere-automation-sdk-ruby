...
module VSphereAutomation
  ...
  class MetadataMetamodelServiceOperationApi
    ...
    # @param operation_id Identifier of the operation element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelServiceOperationResult, Fixnum, Hash)>] VapiMetadataMetamodelServiceOperationResult data, response status code and response headers
    def get_with_http_info(service_id, operation_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataMetamodelServiceOperationResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the operation elements that are defined in the scope of {@param.name serviceId}.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelServiceOperationListResult, Fixnum, Hash)>] VapiMetadataMetamodelServiceOperationListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataMetamodelServiceOperationListResult')
      if @api_client.config.debugging
