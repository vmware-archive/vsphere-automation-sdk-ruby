...
module VSphereAutomation
  ...
  class MetadataPrivilegeServiceOperationApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VapiMetadataPrivilegeServiceOperationGet] :vapi_metadata_privilege_service_operation_get 
    # @return [Array<(VapiMetadataPrivilegeServiceOperationResult, Fixnum, Hash)>] VapiMetadataPrivilegeServiceOperationResult data, response status code and response headers
    def get_with_http_info(service_id, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vapi_metadata_privilege_service_operation_get'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataPrivilegeServiceOperationResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the operation elements contained in the service element corresponding to {@param.name serviceId} that have privilege information.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataPrivilegeServiceOperationListResult, Fixnum, Hash)>] VapiMetadataPrivilegeServiceOperationListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataPrivilegeServiceOperationListResult')
      if @api_client.config.debugging
