...
module VSphereAutomation
  ...
  class RestNavigationServiceApi
    ...
    # Gets list of all vAPI REST {@link Service}s for a vAPI REST {@link Component}.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiRestNavigationServiceListResult, Fixnum, Hash)>] VapiRestNavigationServiceListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiRestNavigationServiceListResult')
      if @api_client.config.debugging
