...
module VSphereAutomation
  ...
  class MetadataPrivilegePackageApi
    ...
    # @param package_id Identifier of the package element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataPrivilegePackageResult, Fixnum, Hash)>] VapiMetadataPrivilegePackageResult data, response status code and response headers
    def get_with_http_info(package_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataPrivilegePackageResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the package elements that have privilege information.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataPrivilegePackageListResult, Fixnum, Hash)>] VapiMetadataPrivilegePackageListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataPrivilegePackageListResult')
      if @api_client.config.debugging
