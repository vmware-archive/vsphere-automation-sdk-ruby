...
module VSphereAutomation
  ...
  class RestNavigationComponentApi
    ...
    # Gets list of all vAPI REST {@link Component}s.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiRestNavigationComponentListResult, Fixnum, Hash)>] VapiRestNavigationComponentListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiRestNavigationComponentListResult')
      if @api_client.config.debugging
