...
module VSphereAutomation
  ...
  class MetadataMetamodelResourceModelApi
    ...
    # @return [VapiMetadataMetamodelResourceModelListResp|VapiStdErrorsNotFoundError|]
    ...
    # @param resource_id Identifier of the resource type.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelResourceModelListResp|VapiStdErrorsNotFoundError|, Fixnum, Hash)>]  data, response status code and response headers
    def list_with_http_info(resource_id, opts = {})
      ...
      # resource path
      local_var_path = '/rest/com/vmware/vapi/metadata/metamodel/resource/model'
	...
	:return_type => {
	  '200' => 'VAPI::VapiMetadataMetamodelResourceModelListResp',
