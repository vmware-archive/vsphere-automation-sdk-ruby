...
module VSphereAutomation
  ...
  class MetadataMetamodelStructureApi
    ...
    # @param structure_id Identifier of the structure element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelStructureResult, Fixnum, Hash)>] VapiMetadataMetamodelStructureResult data, response status code and response headers
    def get_with_http_info(structure_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataMetamodelStructureResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the structure elements that are contained in all the package elements and service elements.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelStructureListResult, Fixnum, Hash)>] VapiMetadataMetamodelStructureListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataMetamodelStructureListResult')
      if @api_client.config.debugging
