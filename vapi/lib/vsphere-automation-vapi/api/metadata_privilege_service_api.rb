...
module VSphereAutomation
  ...
  class MetadataPrivilegeServiceApi
    ...
    # @param service_id Identifier of the service element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataPrivilegeServiceResult, Fixnum, Hash)>] VapiMetadataPrivilegeServiceResult data, response status code and response headers
    def get_with_http_info(service_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataPrivilegeServiceResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the service elements that have privilege information.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataPrivilegeServiceListResult, Fixnum, Hash)>] VapiMetadataPrivilegeServiceListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataPrivilegeServiceListResult')
      if @api_client.config.debugging
