...
module VSphereAutomation
  ...
  class MetadataPrivilegeServiceApi
    ...
    # @return [VapiMetadataPrivilegeServiceResp|VapiStdErrorsNotFoundError|]
    ...
    # @param service_id Identifier of the service element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataPrivilegeServiceResp|VapiStdErrorsNotFoundError|, Fixnum, Hash)>]  data, response status code and response headers
    def get_with_http_info(service_id, opts = {})
      ...
      # resource path
      local_var_path = '/rest/com/vmware/vapi/metadata/privilege/service/id:{service_id}'.sub('{' + 'service_id' + '}', service_id.to_s)
	...
	:return_type => {
	  '200' => 'VAPI::VapiMetadataPrivilegeServiceResp',
    ...
    # @param [Hash] opts the optional parameters
    # @return [VapiMetadataPrivilegeServiceListResp|]
    def list(opts = {})
    ...
    # @api private
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataPrivilegeServiceListResp|, Fixnum, Hash)>]  data, response status code and response headers
    def list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MetadataPrivilegeServiceApi.list ...'
      end
      # resource path
      local_var_path = '/rest/com/vmware/vapi/metadata/privilege/service'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :auth_names => auth_names,
	:return_type => {
	  '200' => 'VAPI::VapiMetadataPrivilegeServiceListResp',
	})
      if @api_client.config.debugging
