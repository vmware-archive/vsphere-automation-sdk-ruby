...
module VSphereAutomation
  ...
  class RestNavigationRootApi
    ...
    # Retrieves information about a vAPI REST {@link Root}.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiRestNavigationRootResult, Fixnum, Hash)>] VapiRestNavigationRootResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiRestNavigationRootResult')
      if @api_client.config.debugging
