...
module VSphereAutomation
  ...
  class MetadataMetamodelComponentApi
    ...
    # @param component_id Identifier of the component element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelComponentFingerprintResult, Fixnum, Hash)>] VapiMetadataMetamodelComponentFingerprintResult data, response status code and response headers
    def fingerprint_with_http_info(component_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataMetamodelComponentFingerprintResult')
      if @api_client.config.debugging
    ...
    # @param component_id Identifier of the component element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelComponentResult, Fixnum, Hash)>] VapiMetadataMetamodelComponentResult data, response status code and response headers
    def get_with_http_info(component_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataMetamodelComponentResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the component elements that are registered with the infrastructure.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelComponentListResult, Fixnum, Hash)>] VapiMetadataMetamodelComponentListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataMetamodelComponentListResult')
      if @api_client.config.debugging
