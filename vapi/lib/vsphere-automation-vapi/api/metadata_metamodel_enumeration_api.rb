...
module VSphereAutomation
  ...
  class MetadataMetamodelEnumerationApi
    ...
    # @param enumeration_id Identifier of the enumeration element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelEnumerationResult, Fixnum, Hash)>] VapiMetadataMetamodelEnumerationResult data, response status code and response headers
    def get_with_http_info(enumeration_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataMetamodelEnumerationResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the enumeration elements that are contained in all the package elements, service elements and structure elements.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelEnumerationListResult, Fixnum, Hash)>] VapiMetadataMetamodelEnumerationListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataMetamodelEnumerationListResult')
      if @api_client.config.debugging
