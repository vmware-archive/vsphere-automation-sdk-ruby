...
module VSphereAutomation
  ...
  class MetadataMetamodelResourceApi
    ...
    # Returns the set of resource types present across all the service elements contained in all the package elements.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelResourceListResult, Fixnum, Hash)>] VapiMetadataMetamodelResourceListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataMetamodelResourceListResult')
      if @api_client.config.debugging
