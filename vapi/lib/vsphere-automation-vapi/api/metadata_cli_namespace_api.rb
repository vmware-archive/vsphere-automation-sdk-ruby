...
module VSphereAutomation
  ...
  class MetadataCliNamespaceApi
    ...
    # Returns the aggregate fingerprint of all the namespace metadata from all the metadata sources. &lt;p&gt; The fingerprint provides clients an efficient way to check if the metadata for namespaces has been modified on the server.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataCliNamespaceFingerprintResult, Fixnum, Hash)>] VapiMetadataCliNamespaceFingerprintResult data, response status code and response headers
    def fingerprint_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataCliNamespaceFingerprintResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VapiMetadataCliNamespaceGet] :vapi_metadata_cli_namespace_get 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VapiMetadataCliNamespaceGet] :vapi_metadata_cli_namespace_get 
    # @return [Array<(VapiMetadataCliNamespaceResult, Fixnum, Hash)>] VapiMetadataCliNamespaceResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vapi_metadata_cli_namespace_get'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataCliNamespaceResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers of all namespaces registered with the infrastructure.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataCliNamespaceListResult, Fixnum, Hash)>] VapiMetadataCliNamespaceListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataCliNamespaceListResult')
      if @api_client.config.debugging
