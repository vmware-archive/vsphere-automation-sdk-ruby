...
module VSphereAutomation
  ...
  class MetadataMetamodelPackageApi
    ...
    # @param package_id Identifier of the package element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelPackageResult, Fixnum, Hash)>] VapiMetadataMetamodelPackageResult data, response status code and response headers
    def get_with_http_info(package_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataMetamodelPackageResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the packages elements that are contained in all the registered component elements.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataMetamodelPackageListResult, Fixnum, Hash)>] VapiMetadataMetamodelPackageListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataMetamodelPackageListResult')
      if @api_client.config.debugging
