...
module VSphereAutomation
  ...
  class MetadataAuthenticationPackageApi
    ...
    # @param package_id Identifier of the package element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataAuthenticationPackageResult, Fixnum, Hash)>] VapiMetadataAuthenticationPackageResult data, response status code and response headers
    def get_with_http_info(package_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataAuthenticationPackageResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the package elements that have authentication information.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataAuthenticationPackageListResult, Fixnum, Hash)>] VapiMetadataAuthenticationPackageListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataAuthenticationPackageListResult')
      if @api_client.config.debugging
