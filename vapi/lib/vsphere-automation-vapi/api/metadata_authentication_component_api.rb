...
module VSphereAutomation
  ...
  class MetadataAuthenticationComponentApi
    ...
    # @param component_id Identifier of the component element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataAuthenticationComponentFingerprintResult, Fixnum, Hash)>] VapiMetadataAuthenticationComponentFingerprintResult data, response status code and response headers
    def fingerprint_with_http_info(component_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataAuthenticationComponentFingerprintResult')
      if @api_client.config.debugging
    ...
    # @param component_id Identifier of the component element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataAuthenticationComponentResult, Fixnum, Hash)>] VapiMetadataAuthenticationComponentResult data, response status code and response headers
    def get_with_http_info(component_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataAuthenticationComponentResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the component elements that have authentication information.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataAuthenticationComponentListResult, Fixnum, Hash)>] VapiMetadataAuthenticationComponentListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataAuthenticationComponentListResult')
      if @api_client.config.debugging
