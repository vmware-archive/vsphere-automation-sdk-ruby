...
module VSphereAutomation
  ...
  class RestNavigationResourceApi
    ...
    # @param instance_id Resource instance id.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiRestNavigationResourceResult, Fixnum, Hash)>] VapiRestNavigationResourceResult data, response status code and response headers
    def get_with_http_info(type_id, instance_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiRestNavigationResourceResult')
      if @api_client.config.debugging
    ...
    # Gets list of all vAPI REST {@link Resource}s.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiRestNavigationResourceListResult, Fixnum, Hash)>] VapiRestNavigationResourceListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiRestNavigationResourceListResult')
      if @api_client.config.debugging
