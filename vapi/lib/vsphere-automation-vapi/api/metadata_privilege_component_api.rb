...
module VSphereAutomation
  ...
  class MetadataPrivilegeComponentApi
    ...
    # @param component_id Identifier of the component element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataPrivilegeComponentFingerprintResult, Fixnum, Hash)>] VapiMetadataPrivilegeComponentFingerprintResult data, response status code and response headers
    def fingerprint_with_http_info(component_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataPrivilegeComponentFingerprintResult')
      if @api_client.config.debugging
    ...
    # @param component_id Identifier of the component element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataPrivilegeComponentResult, Fixnum, Hash)>] VapiMetadataPrivilegeComponentResult data, response status code and response headers
    def get_with_http_info(component_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataPrivilegeComponentResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the component elements that have privilege information.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataPrivilegeComponentListResult, Fixnum, Hash)>] VapiMetadataPrivilegeComponentListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataPrivilegeComponentListResult')
      if @api_client.config.debugging
