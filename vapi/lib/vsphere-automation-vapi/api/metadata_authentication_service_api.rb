...
module VSphereAutomation
  ...
  class MetadataAuthenticationServiceApi
    ...
    # @param service_id Identifier of the service element.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataAuthenticationServiceResult, Fixnum, Hash)>] VapiMetadataAuthenticationServiceResult data, response status code and response headers
    def get_with_http_info(service_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VAPI::VapiMetadataAuthenticationServiceResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers for the service elements that have authentication information.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VapiMetadataAuthenticationServiceListResult, Fixnum, Hash)>] VapiMetadataAuthenticationServiceListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VAPI::VapiMetadataAuthenticationServiceListResult')
      if @api_client.config.debugging
