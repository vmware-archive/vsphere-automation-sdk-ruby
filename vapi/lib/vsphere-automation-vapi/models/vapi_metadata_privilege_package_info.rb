...
module VSphereAutomation
  module VAPI
    class VapiMetadataPrivilegePackageInfo
    ...
    # Information about all service elements contained in this package element that contain privilege information. The key in the {@term map} is the identifier of the service element and the value in the {@term map} is the privilege information for the service element. For an explanation of privilege information containment within service elements, see {@link vapi.metadata.privilege.Service}.
    ...
    def self.openapi_types
      {
        ...
        :'services' => :'Array<VapiMetadataPrivilegePackageInfoServices>'
      }
    end
