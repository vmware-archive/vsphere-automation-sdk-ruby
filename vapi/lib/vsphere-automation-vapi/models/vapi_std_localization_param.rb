...
module VSphereAutomation
  module VAPI
    class VapiStdLocalizationParam
    ...
    def self.openapi_types
      {
        :'d' => :'Float',
        :'dt' => :'DateTime',
        :'format' => :'VapiStdLocalizationParamDateTimeFormat',
        :'i' => :'Integer',
        :'l' => :'VapiStdNestedLocalizableMessage',
        :'precision' => :'Integer',
        :'s' => :'String'
      }
    end
    ...
    def hash
      [d, dt, format, i, l, precision, s].hash
    end
