  ...
  module VAPI
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'map_key_type')
        self.map_key_type = attributes[:'map_key_type']
      end

      if attributes.has_key?(:'map_value_type')
        self.map_value_type = attributes[:'map_value_type']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @generic_type.nil?
        invalid_properties.push('invalid value for "generic_type", generic_type cannot be nil.')
      end
    ...
    def valid?
      return false if @generic_type.nil?
      true
    end
