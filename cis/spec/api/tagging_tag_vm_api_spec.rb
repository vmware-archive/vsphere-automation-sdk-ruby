...
# Unit tests for VSphereAutomation::CIS::TaggingTagVMApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TaggingTagVMApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::CIS::TaggingTagVMApi.new
  end
  ...
  describe 'test an instance of TaggingTagVMApi' do
    it 'should create an instance of TaggingTagVMApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::CIS::TaggingTagVMApi)
    end
  end
