...
module VSphereAutomation
  ...
  class TasksApi
    ...
    # @param task Task identifier. The parameter must be an identifier for the resource type: cis.task.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CisTasksResult, Fixnum, Hash)>] CisTasksResult data, response status code and response headers
    def get_with_http_info(task, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CIS::CisTasksResult')
      if @api_client.config.debugging
    ...
    # Returns information about at most 1000 visible (subject to permission checks) tasks matching the Tasks.FilterSpec. All tasks must be in the same provider.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CisTasksListResult, Fixnum, Hash)>] CisTasksListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CIS::CisTasksListResult')
      if @api_client.config.debugging
