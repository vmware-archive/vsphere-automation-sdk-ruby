...
module VSphereAutomation
  ...
  class TaggingCategoryApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [CisTaggingCategoryCreate] :cis_tagging_category_create 
    # @return [Array<(CisTaggingCategoryCreateResult, Fixnum, Hash)>] CisTaggingCategoryCreateResult data, response status code and response headers
    def create_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CIS::CisTaggingCategoryCreateResult')
      if @api_client.config.debugging
    ...
    # @param category_id The identifier of the input category.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CisTaggingCategoryResult, Fixnum, Hash)>] CisTaggingCategoryResult data, response status code and response headers
    def get_with_http_info(category_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CIS::CisTaggingCategoryResult')
      if @api_client.config.debugging
    ...
    # Enumerates the categories in the system. To invoke this {@term operation}, you need the read privilege on the individual categories. The {@term list} will only contain those categories for which you have read privileges.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CisTaggingCategoryListResult, Fixnum, Hash)>] CisTaggingCategoryListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CIS::CisTaggingCategoryListResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [CisTaggingCategoryListUsedCategories] :cis_tagging_category_list_used_categories 
    # @return [Array<(CisTaggingCategoryListUsedCategoriesResult, Fixnum, Hash)>] CisTaggingCategoryListUsedCategoriesResult data, response status code and response headers
    def list_used_categories_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CIS::CisTaggingCategoryListUsedCategoriesResult')
      if @api_client.config.debugging
