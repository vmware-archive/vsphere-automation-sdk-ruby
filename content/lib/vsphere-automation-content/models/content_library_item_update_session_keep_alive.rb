...
module VSphereAutomation
  module Content
    class ContentLibraryItemUpdateSessionKeepAlive
    # Optional update to the progress property of the session. If specified, the new progress should be greater then the current progress. See {@link UpdateSessionModel#clientProgress}.
