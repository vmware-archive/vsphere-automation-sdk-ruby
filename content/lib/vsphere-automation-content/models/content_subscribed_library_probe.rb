...
module VSphereAutomation
  module Content
    class ContentSubscribedLibraryProbe
    ...
    def list_invalid_properties
      ...
      if @subscription_info.nil?
        invalid_properties.push('invalid value for "subscription_info", subscription_info cannot be nil.')
      end
    ...
    def valid?
      return false if @subscription_info.nil?
      true
    end
