...
module VSphereAutomation
  module Content
    class ContentLibraryItemDownloadSessionFail
    ...
    attr_accessor :client_error_message
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'client_error_message')
        self.client_error_message = attributes[:'client_error_message']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @client_error_message.nil?
        invalid_properties.push('invalid value for "client_error_message", client_error_message cannot be nil.')
      end
    ...
    def valid?
      return false if @client_error_message.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          client_error_message == o.client_error_message
    end
