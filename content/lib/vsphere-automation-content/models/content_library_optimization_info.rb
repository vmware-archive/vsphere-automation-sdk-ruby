...
module VSphereAutomation
  module Content
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'optimize_remote_publishing')
        self.optimize_remote_publishing = attributes[:'optimize_remote_publishing']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          optimize_remote_publishing == o.optimize_remote_publishing
    end
    ...
    def hash
      [optimize_remote_publishing].hash
    end
