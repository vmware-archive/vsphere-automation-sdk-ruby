...
module VSphereAutomation
  module Content
    class ContentLibraryItemDownloadSessionCreate
    # A unique token generated by the client for each creation request. The token should be a universally unique identifier (UUID), for example: {@code b8a2a2e3-2314-43cd-a871-6ede0f429751}. This token can be used to guarantee idempotent creation.
    ...
    def self.openapi_types
      {
        :'client_token' => :'String',
        :'create_spec' => :'ContentLibraryItemDownloadSessionModel'
      }
    end
