...
module VSphereAutomation
  module Content
    ...
    # The type which the plugin supports. <p> To upload a library item of the type supported by the plugin, the {@link ItemModel#type} {@term field} of the item should be set to this value.
    attr_accessor :type
    ...
    def hash
      [description, name, type, vendor, version].hash
    end
