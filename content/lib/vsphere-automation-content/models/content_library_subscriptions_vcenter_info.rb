...
module VSphereAutomation
  module Content
    class ContentLibrarySubscriptionsVcenterInfo
    ...
    def list_invalid_properties
      ...
      if @server_guid.nil?
        invalid_properties.push('invalid value for "server_guid", server_guid cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @server_guid.nil?
      true
    end
    ...
    def hash
      [hostname, https_port, server_guid].hash
    end
