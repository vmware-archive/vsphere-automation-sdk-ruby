...
module VSphereAutomation
  module Content
    class ContentLibraryItemChangesSummary
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'short_message')
        self.short_message = attributes[:'short_message']
      end
    ...
    def hash
      [short_message, time, user, version].hash
    end
