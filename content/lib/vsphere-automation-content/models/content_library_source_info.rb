...
module VSphereAutomation
  module Content
    class ContentLibrarySourceInfo
    # Identifier of the published library.
    attr_accessor :source_library
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'source_library')
        self.source_library = attributes[:'source_library']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          source_library == o.source_library &&
    ...
    def hash
      [source_library, subscription].hash
    end
