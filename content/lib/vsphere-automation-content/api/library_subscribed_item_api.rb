...
module VSphereAutomation
  ...
  class LibrarySubscribedItemApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibrarySubscribedItemSync] :content_library_subscribed_item_sync 
    # @return [nil]
    def sync(library_item_id, opts = {})
      sync_with_http_info(library_item_id, opts)
      nil
    end
    ...
    # @option opts [ContentLibrarySubscribedItemSync] :content_library_subscribed_item_sync 
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def sync_with_http_info(library_item_id, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_library_subscribed_item_sync'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
