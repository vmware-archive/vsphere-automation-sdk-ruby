...
module VSphereAutomation
  ...
  class LibraryItemFileApi
    ...
    # @option opts [ContentLibraryItemFileGet] :content_library_item_file_get 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryItemFileGet] :content_library_item_file_get 
    # @return [Array<(ContentLibraryItemFileResult, Fixnum, Hash)>] ContentLibraryItemFileResult data, response status code and response headers
    def get_with_http_info(library_item_id, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_library_item_file_get'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Content::ContentLibraryItemFileResult')
      if @api_client.config.debugging
    ...
    # Lists all of the files that are stored within a given library item.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryItemFileListResult, Fixnum, Hash)>] ContentLibraryItemFileListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLibraryItemFileListResult')
      if @api_client.config.debugging
