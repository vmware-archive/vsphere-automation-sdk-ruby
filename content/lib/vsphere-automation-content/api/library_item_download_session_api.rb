...
module VSphereAutomation
  ...
  class LibraryItemDownloadSessionApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryItemDownloadSessionCreate] :content_library_item_download_session_create 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryItemDownloadSessionCreate] :content_library_item_download_session_create 
    # @return [Array<(ContentLibraryItemDownloadSessionCreateResult, Fixnum, Hash)>] ContentLibraryItemDownloadSessionCreateResult data, response status code and response headers
    def create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_library_item_download_session_create'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLibraryItemDownloadSessionCreateResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryItemDownloadSessionFail] :content_library_item_download_session_fail 
    # @return [nil]
    def fail(download_session_id, opts = {})
      fail_with_http_info(download_session_id, opts)
      nil
    end
    ...
    # @option opts [ContentLibraryItemDownloadSessionFail] :content_library_item_download_session_fail 
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def fail_with_http_info(download_session_id, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_library_item_download_session_fail'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
    ...
    # @param download_session_id Identifier of the download session to retrieve.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryItemDownloadSessionResult, Fixnum, Hash)>] ContentLibraryItemDownloadSessionResult data, response status code and response headers
    def get_with_http_info(download_session_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLibraryItemDownloadSessionResult')
      if @api_client.config.debugging
    ...
    # @param content_library_item_download_session_keep_alive 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def keep_alive(download_session_id, content_library_item_download_session_keep_alive, opts = {})
      keep_alive_with_http_info(download_session_id, content_library_item_download_session_keep_alive, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def keep_alive_with_http_info(download_session_id, content_library_item_download_session_keep_alive, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'content_library_item_download_session_keep_alive' is set
      if @api_client.config.client_side_validation && content_library_item_download_session_keep_alive.nil?
        fail ArgumentError, "Missing the required parameter 'content_library_item_download_session_keep_alive' when calling LibraryItemDownloadSessionApi.keep_alive"
      end
      # resource path
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(content_library_item_download_session_keep_alive)
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
    ...
    # Lists the identifiers of the download sessions created by the calling user. Optionally may filter by library item.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryItemDownloadSessionListResult, Fixnum, Hash)>] ContentLibraryItemDownloadSessionListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLibraryItemDownloadSessionListResult')
      if @api_client.config.debugging
