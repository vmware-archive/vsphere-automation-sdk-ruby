...
module VSphereAutomation
  ...
  class LibraryItemDownloadsessionFileApi
    ...
    # @option opts [ContentLibraryItemDownloadsessionFileGet] :content_library_item_downloadsession_file_get 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryItemDownloadsessionFileGet] :content_library_item_downloadsession_file_get 
    # @return [Array<(ContentLibraryItemDownloadsessionFileResult, Fixnum, Hash)>] ContentLibraryItemDownloadsessionFileResult data, response status code and response headers
    def get_with_http_info(download_session_id, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_library_item_downloadsession_file_get'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Content::ContentLibraryItemDownloadsessionFileResult')
      if @api_client.config.debugging
    ...
    # Lists the information of all the files in the library item associated with the download session.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryItemDownloadsessionFileListResult, Fixnum, Hash)>] ContentLibraryItemDownloadsessionFileListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLibraryItemDownloadsessionFileListResult')
      if @api_client.config.debugging
    ...
    # @param download_session_id Identifier of the download session.
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryItemDownloadsessionFilePrepare] :content_library_item_downloadsession_file_prepare 
    # @return [ContentLibraryItemDownloadsessionFilePrepareResult]
    def prepare(download_session_id, opts = {})
      data, _status_code, _headers = prepare_with_http_info(download_session_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryItemDownloadsessionFilePrepare] :content_library_item_downloadsession_file_prepare 
    # @return [Array<(ContentLibraryItemDownloadsessionFilePrepareResult, Fixnum, Hash)>] ContentLibraryItemDownloadsessionFilePrepareResult data, response status code and response headers
    def prepare_with_http_info(download_session_id, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_library_item_downloadsession_file_prepare'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLibraryItemDownloadsessionFilePrepareResult')
      if @api_client.config.debugging
