...
module VSphereAutomation
  ...
  class ConfigurationApi
    ...
    # Retrieves the current configuration values.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentConfigurationResult, Fixnum, Hash)>] ContentConfigurationResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Content::ContentConfigurationResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentConfigurationUpdate] :content_configuration_update 
    # @return [nil]
    def update(opts = {})
    ...
    def update_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_configuration_update'])
      auth_names = []
