...
module VSphereAutomation
  ...
  class SubscribedLibraryApi
    ...
    # @option opts [ContentSubscribedLibraryCreate] :content_subscribed_library_create 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentSubscribedLibraryCreate] :content_subscribed_library_create 
    # @return [Array<(ContentSubscribedLibraryCreateResult, Fixnum, Hash)>] ContentSubscribedLibraryCreateResult data, response status code and response headers
    def create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_subscribed_library_create'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Content::ContentSubscribedLibraryCreateResult')
      if @api_client.config.debugging
    ...
    # @param library_id Identifier of the subscribed library to return.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentSubscribedLibraryResult, Fixnum, Hash)>] ContentSubscribedLibraryResult data, response status code and response headers
    def get_with_http_info(library_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentSubscribedLibraryResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers of all subscribed libraries in the Content Library.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentSubscribedLibraryListResult, Fixnum, Hash)>] ContentSubscribedLibraryListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentSubscribedLibraryListResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentSubscribedLibraryProbe] :content_subscribed_library_probe 
    # @return [ContentSubscribedLibraryProbeResult]
    def probe(opts = {})
      data, _status_code, _headers = probe_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentSubscribedLibraryProbe] :content_subscribed_library_probe 
    # @return [Array<(ContentSubscribedLibraryProbeResult, Fixnum, Hash)>] ContentSubscribedLibraryProbeResult data, response status code and response headers
    def probe_with_http_info(opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_subscribed_library_probe'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentSubscribedLibraryProbeResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentSubscribedLibraryUpdate] :content_subscribed_library_update 
    # @return [nil]
    def update(library_id, opts = {})
      update_with_http_info(library_id, opts)
      nil
    end
    ...
    # @option opts [ContentSubscribedLibraryUpdate] :content_subscribed_library_update 
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def update_with_http_info(library_id, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_subscribed_library_update'])
      auth_names = []
