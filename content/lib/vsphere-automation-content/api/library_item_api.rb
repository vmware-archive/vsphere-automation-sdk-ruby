...
module VSphereAutomation
  ...
  class LibraryItemApi
    ...
    # @return [ContentLibraryItemCopyResp|VapiStdErrorsNotAllowedInCurrentStateError|VapiStdErrorsNotFoundError|]
    ...
    # @param request_body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryItemCopyResp|VapiStdErrorsNotAllowedInCurrentStateError|VapiStdErrorsNotFoundError|, Fixnum, Hash)>]  data, response status code and response headers
    def copy_with_http_info(source_library_item_id, request_body, opts = {})
      ...
      # resource path
      local_var_path = '/rest/com/vmware/content/library/item/id:{source_library_item_id}?~action=copy'.sub('{' + 'source_library_item_id' + '}', source_library_item_id.to_s)
	...
	:return_type => {
	  '200' => 'Content::ContentLibraryItemCopyResp',
    ...
    # @param request_body 
    # @param [Hash] opts the optional parameters
    # @return [ContentLibraryItemCreateResp|VapiStdErrorsAlreadyExistsError|VapiStdErrorsNotFoundError|]
    ...
    # @param request_body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryItemCreateResp|VapiStdErrorsAlreadyExistsError|VapiStdErrorsNotFoundError|, Fixnum, Hash)>]  data, response status code and response headers
    def create_with_http_info(request_body, opts = {})
      ...
      # resource path
      local_var_path = '/rest/com/vmware/content/library/item'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names,
	:return_type => {
	  '200' => 'Content::ContentLibraryItemCreateResp',
    ...
    def delete_with_http_info(library_item_id, opts = {})
      ...
      # resource path
      local_var_path = '/rest/com/vmware/content/library/item/id:{library_item_id}'.sub('{' + 'library_item_id' + '}', library_item_id.to_s)
    ...
    # @param request_body 
    # @param [Hash] opts the optional parameters
    # @return [ContentLibraryItemFindResp|VapiStdErrorsInvalidArgumentError|]
    ...
    # @param request_body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryItemFindResp|VapiStdErrorsInvalidArgumentError|, Fixnum, Hash)>]  data, response status code and response headers
    def find_with_http_info(request_body, opts = {})
      ...
      # resource path
      local_var_path = '/rest/com/vmware/content/library/item?~action=find'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names,
	:return_type => {
	  '200' => 'Content::ContentLibraryItemFindResp',
    ...
    # @param [Hash] opts the optional parameters
    # @return [ContentLibraryItemResp|VapiStdErrorsNotFoundError|]
    ...
    # @param library_item_id Identifier of the library item to return.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryItemResp|VapiStdErrorsNotFoundError|, Fixnum, Hash)>]  data, response status code and response headers
    def get_with_http_info(library_item_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :auth_names => auth_names,
	:return_type => {
	  '200' => 'Content::ContentLibraryItemResp',
	  '404' => 'Content::VapiStdErrorsNotFoundError',
	})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [ContentLibraryItemListResp|VapiStdErrorsNotFoundError|]
    ...
    # @param library_id Identifier of the library whose items should be returned.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryItemListResp|VapiStdErrorsNotFoundError|, Fixnum, Hash)>]  data, response status code and response headers
    def list_with_http_info(library_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :auth_names => auth_names,
	:return_type => {
	  '200' => 'Content::ContentLibraryItemListResp',
	  '404' => 'Content::VapiStdErrorsNotFoundError',
	})
      if @api_client.config.debugging
    ...
    def publish_with_http_info(library_item_id, request_body, opts = {})
      ...
      # resource path
      local_var_path = '/rest/com/vmware/content/library/item/id:{library_item_id}?~action=publish'.sub('{' + 'library_item_id' + '}', library_item_id.to_s)
