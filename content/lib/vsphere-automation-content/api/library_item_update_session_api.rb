...
module VSphereAutomation
  ...
  class LibraryItemUpdateSessionApi
    ...
    private def cancel_with_http_info(update_session_id, opts = {})
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(|VapiStdErrorsNotAllowedInCurrentStateError|VapiStdErrorsNotFoundError|nil, Fixnum, Hash)>] nil, response status code and response headers
    private def complete_with_http_info(update_session_id, opts = {})
      if @api_client.config.debugging
    ...
    private def create_with_http_info(content_library_item_update_session_create, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(|VapiStdErrorsNotAllowedInCurrentStateError|VapiStdErrorsNotFoundError|nil, Fixnum, Hash)>] nil, response status code and response headers
    private def delete_with_http_info(update_session_id, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(|VapiStdErrorsNotAllowedInCurrentStateError|VapiStdErrorsNotFoundError|nil, Fixnum, Hash)>] nil, response status code and response headers
    private def fail_with_http_info(update_session_id, content_library_item_update_session_fail, opts = {})
      if @api_client.config.debugging
    ...
    private def get_with_http_info(update_session_id, opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [ContentLibraryItemUpdateSessionKeepAlive] :content_library_item_update_session_keep_alive 
    # @return [Array<(|VapiStdErrorsNotAllowedInCurrentStateError|VapiStdErrorsNotFoundError|nil, Fixnum, Hash)>] nil, response status code and response headers
    private def keep_alive_with_http_info(update_session_id, opts = {})
      if @api_client.config.debugging
    ...
    private def update_with_http_info(update_session_id, content_library_item_update_session_update, opts = {})
      if @api_client.config.debugging
