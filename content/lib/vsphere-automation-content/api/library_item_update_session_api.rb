...
module VSphereAutomation
  ...
  class LibraryItemUpdateSessionApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryItemUpdateSessionCreate] :content_library_item_update_session_create 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryItemUpdateSessionCreate] :content_library_item_update_session_create 
    # @return [Array<(ContentLibraryItemUpdateSessionCreateResult, Fixnum, Hash)>] ContentLibraryItemUpdateSessionCreateResult data, response status code and response headers
    def create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_library_item_update_session_create'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLibraryItemUpdateSessionCreateResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryItemUpdateSessionFail] :content_library_item_update_session_fail 
    # @return [nil]
    def fail(update_session_id, opts = {})
      fail_with_http_info(update_session_id, opts)
      nil
    end
    ...
    # @option opts [ContentLibraryItemUpdateSessionFail] :content_library_item_update_session_fail 
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def fail_with_http_info(update_session_id, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_library_item_update_session_fail'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
    ...
    # @param update_session_id Identifier of the update session to retrieve.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryItemUpdateSessionResult, Fixnum, Hash)>] ContentLibraryItemUpdateSessionResult data, response status code and response headers
    def get_with_http_info(update_session_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLibraryItemUpdateSessionResult')
      if @api_client.config.debugging
    ...
    # @param content_library_item_update_session_keep_alive 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def keep_alive(update_session_id, content_library_item_update_session_keep_alive, opts = {})
      keep_alive_with_http_info(update_session_id, content_library_item_update_session_keep_alive, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def keep_alive_with_http_info(update_session_id, content_library_item_update_session_keep_alive, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'content_library_item_update_session_keep_alive' is set
      if @api_client.config.client_side_validation && content_library_item_update_session_keep_alive.nil?
        fail ArgumentError, "Missing the required parameter 'content_library_item_update_session_keep_alive' when calling LibraryItemUpdateSessionApi.keep_alive"
      end
      # resource path
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(content_library_item_update_session_keep_alive)
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
    ...
    # Lists the identifiers of the update session created by the calling user. Optionally may filter by library item.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryItemUpdateSessionListResult, Fixnum, Hash)>] ContentLibraryItemUpdateSessionListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLibraryItemUpdateSessionListResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryItemUpdateSessionUpdate] :content_library_item_update_session_update 
    # @return [nil]
    def update(update_session_id, opts = {})
      update_with_http_info(update_session_id, opts)
      nil
    end
    ...
    # @option opts [ContentLibraryItemUpdateSessionUpdate] :content_library_item_update_session_update 
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def update_with_http_info(update_session_id, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_library_item_update_session_update'])
      auth_names = []
