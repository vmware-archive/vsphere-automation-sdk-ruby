...
module VSphereAutomation
  ...
  class LibraryApi
    ...
    # @option opts [ContentLibraryFind] :content_library_find 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryFind] :content_library_find 
    # @return [Array<(ContentLibraryFindResult, Fixnum, Hash)>] ContentLibraryFindResult data, response status code and response headers
    def find_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_library_find'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Content::ContentLibraryFindResult')
      if @api_client.config.debugging
    ...
    # @param library_id Identifier of the library to return.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryResult, Fixnum, Hash)>] ContentLibraryResult data, response status code and response headers
    def get_with_http_info(library_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLibraryResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers of all libraries of any type in the Content Library.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLibraryListResult, Fixnum, Hash)>] ContentLibraryListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLibraryListResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLibraryUpdate] :content_library_update 
    # @return [nil]
    ...
    def update_with_http_info(library_id, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_library_update'])
      auth_names = []
