...
module VSphereAutomation
  ...
  class LocalLibraryApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ContentLocalLibraryCreate] :content_local_library_create 
    # @return [Array<(ContentLocalLibraryCreateResult, Fixnum, Hash)>] ContentLocalLibraryCreateResult data, response status code and response headers
    def create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_local_library_create'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Content::ContentLocalLibraryCreateResult')
      if @api_client.config.debugging
    ...
    # @param library_id Identifier of the local library to return.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLocalLibraryResult, Fixnum, Hash)>] ContentLocalLibraryResult data, response status code and response headers
    def get_with_http_info(library_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLocalLibraryResult')
      if @api_client.config.debugging
    ...
    # Returns the identifiers of all local libraries in the Content Library.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContentLocalLibraryListResult, Fixnum, Hash)>] ContentLocalLibraryListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Content::ContentLocalLibraryListResult')
      if @api_client.config.debugging
    ...
    def update_with_http_info(library_id, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'content_local_library_update'])
      auth_names = []
