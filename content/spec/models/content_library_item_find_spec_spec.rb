...
# Unit tests for VSphereAutomation::Content::ContentLibraryItemFindSpec
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContentLibraryItemFindSpec' do
  before do
    # run before each test
    @instance = VSphereAutomation::Content::ContentLibraryItemFindSpec.new
  end
  ...
  describe 'test an instance of ContentLibraryItemFindSpec' do
    it 'should create an instance of ContentLibraryItemFindSpec' do
