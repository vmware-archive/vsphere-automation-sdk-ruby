...
# Unit tests for VSphereAutomation::Content::VapiStdErrorsUnsupportedError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VapiStdErrorsUnsupportedError' do
  before do
    # run before each test
    @instance = VSphereAutomation::Content::VapiStdErrorsUnsupportedError.new
  end
  ...
  describe 'test an instance of VapiStdErrorsUnsupportedError' do
    it 'should create an instance of VapiStdErrorsUnsupportedError' do
      expect(@instance).to be_instance_of(VSphereAutomation::Content::VapiStdErrorsUnsupportedError)
    end
  end
