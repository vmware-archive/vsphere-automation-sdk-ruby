...
# Unit tests for VSphereAutomation::Content::VapiStdErrorsUnauthorizedError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VapiStdErrorsUnauthorizedError' do
  before do
    # run before each test
    @instance = VSphereAutomation::Content::VapiStdErrorsUnauthorizedError.new
  end
  ...
  describe 'test an instance of VapiStdErrorsUnauthorizedError' do
    it 'should create an instance of VapiStdErrorsUnauthorizedError' do
      expect(@instance).to be_instance_of(VSphereAutomation::Content::VapiStdErrorsUnauthorizedError)
    end
  end
