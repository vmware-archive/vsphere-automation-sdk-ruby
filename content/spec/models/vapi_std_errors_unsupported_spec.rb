...
# Unit tests for VSphereAutomation::Content::VapiStdErrorsUnsupported
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VapiStdErrorsUnsupported' do
  before do
    # run before each test
    @instance = VSphereAutomation::Content::VapiStdErrorsUnsupported.new
  end
  ...
  describe 'test an instance of VapiStdErrorsUnsupported' do
    it 'should create an instance of VapiStdErrorsUnsupported' do
      expect(@instance).to be_instance_of(VSphereAutomation::Content::VapiStdErrorsUnsupported)
    end
  end
