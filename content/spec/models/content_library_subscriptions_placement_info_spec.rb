...
# Unit tests for VSphereAutomation::Content::ContentLibrarySubscriptionsPlacementInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContentLibrarySubscriptionsPlacementInfo' do
  before do
    # run before each test
    @instance = VSphereAutomation::Content::ContentLibrarySubscriptionsPlacementInfo.new
  end
  ...
  describe 'test an instance of ContentLibrarySubscriptionsPlacementInfo' do
    it 'should create an instance of ContentLibrarySubscriptionsPlacementInfo' do
