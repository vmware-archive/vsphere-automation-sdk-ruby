...
module VSphereAutomation
  module Appliance
    class ApplianceTechpreviewNetworkingIpv6IPv6Config
    ...
    def self.openapi_types
      {
        :'addresses' => :'Array<ApplianceTechpreviewNetworkingIpv6IPv6Address>',
        :'autoconf' => :'Boolean',
    ...
    def hash
      [addresses, autoconf, default_gateway, dhcp, interface_name].hash
    end
