...
module VSphereAutomation
  module Appliance
    ...
    def hash
      [cancelable, description, end_time, error, operation, parent, progress, service, start_time, status, subtask_order, subtasks, target, user].hash
    end
