...
module VSphereAutomation
  module Appliance
    ...
    def hash
      [build, cancelable, description, duration, end_time, error, location, location_user, messages, operation, parent, progress, service, size, start_time, status, target, type, user].hash
    end
