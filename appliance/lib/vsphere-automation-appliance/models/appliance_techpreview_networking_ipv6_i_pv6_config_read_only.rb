...
module VSphereAutomation
  module Appliance
    class ApplianceTechpreviewNetworkingIpv6IPv6ConfigReadOnly
    ...
    def self.openapi_types
      {
        :'addresses' => :'Array<ApplianceTechpreviewNetworkingIpv6IPv6AddressReadOnly>',
        :'autoconf' => :'Boolean',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'updateable')
        self.updateable = attributes[:'updateable']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @interface_name.nil?
        invalid_properties.push('invalid value for "interface_name", interface_name cannot be nil.')
      end

      if @updateable.nil?
        invalid_properties.push('invalid value for "updateable", updateable cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @updateable.nil?
      true
    end
    ...
    def hash
      [addresses, autoconf, default_gateway, dhcp, interface_name, updateable].hash
    end
