...
module VSphereAutomation
  module Appliance
    class ApplianceInfraprofileConfigsProfilesSpec
    ...
    def hash
      [description, encryption_key, profiles].hash
    end
