...
module VSphereAutomation
  module Appliance
    class ApplianceTechpreviewNetworkingRoutesRouteReadOnly
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'is_static')
    ...
    def list_invalid_properties
      ...
      if @is_static.nil?
        invalid_properties.push('invalid value for "is_static", is_static cannot be nil.')
      end
    ...
    def hash
      [destination, gateway, interface_name, is_static, prefix].hash
    end
