...
module VSphereAutomation
  module Appliance
    ...
    def self.openapi_types
      {
        :'name' => :'String',
        :'status' => :'ApplianceObservabilityConsumersStatus',
        :'topics' => :'Array<String>'
      }
    end
