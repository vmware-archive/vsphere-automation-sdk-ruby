...
module VSphereAutomation
  module Appliance
    class ApplianceObservabilityInternalPluginsSummary
    # Detailed info about the plugin as json.
    attr_accessor :info
    ...
    def self.openapi_types
      {
        :'info' => :'String',
        :'name' => :'String',
        :'state' => :'ApplianceObservabilityInternalPluginsState'
      }
    end
