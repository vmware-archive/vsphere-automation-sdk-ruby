...
module VSphereAutomation
  module Appliance
    class ApplianceLocalAccountsPolicyInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'max_days')
        self.max_days = attributes[:'max_days']
      end

      if attributes.has_key?(:'min_days')
        self.min_days = attributes[:'min_days']
      end

      if attributes.has_key?(:'warn_days')
        self.warn_days = attributes[:'warn_days']
      end
    end
    ...
    def hash
      [max_days, min_days, warn_days].hash
    end
