...
module VSphereAutomation
  module Appliance
    class ApplianceUpdateHistorySummary
    ...
    # Update release date. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    ...
    # Version of the update. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    ...
    def self.openapi_types
      {
        ...
        :'severity' => :'ApplianceUpdateHistorySeverity',
        :'update_type' => :'ApplianceUpdateHistoryCategory',
        :'version' => :'String'
      }
    end
    ...
    def hash
      [install_date, name, release_date, severity, update_type, version].hash
    end
