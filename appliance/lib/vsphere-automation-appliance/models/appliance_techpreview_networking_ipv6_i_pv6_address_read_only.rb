...
module VSphereAutomation
  module Appliance
    class ApplianceTechpreviewNetworkingIpv6IPv6AddressReadOnly
    ...
    def self.openapi_types
      {
        :'address' => :'String',
        :'origin' => :'ApplianceTechpreviewNetworkingIpv6IPv6AddressOrigin',
        :'prefix' => :'Integer',
        :'status' => :'ApplianceTechpreviewNetworkingIpv6IPv6AddressStatus'
      }
    end
