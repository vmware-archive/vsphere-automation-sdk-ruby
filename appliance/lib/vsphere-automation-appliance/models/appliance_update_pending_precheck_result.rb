...
module VSphereAutomation
  module Appliance
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'estimated_time_to_install')
        self.estimated_time_to_install = attributes[:'estimated_time_to_install']
      end

      if attributes.has_key?(:'estimated_time_to_rollback')
