...
module VSphereAutomation
  module Appliance
    class ApplianceRecoveryBackupSchedulesUpdateSpec
    # List of optional parts. Use the {@link appliance.recovery.backup.Parts#list} {@term operation} to get information about the supported parts.
    attr_accessor :parts
