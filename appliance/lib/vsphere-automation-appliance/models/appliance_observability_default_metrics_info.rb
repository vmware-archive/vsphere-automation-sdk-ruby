...
module VSphereAutomation
  module Appliance
    class ApplianceObservabilityDefaultMetricsInfo
    # Type of resource the metric is applicable on.
    ...
    def self.openapi_types
      {
        ...
        :'source' => :'String',
        :'status' => :'ApplianceObservabilityDefaultMetricsStatus',
        :'topic' => :'String',
        :'unit' => :'String',
        :'value_type' => :'String'
      }
    ...
    def hash
      [resource_type, source, status, topic, unit, value_type].hash
    end
