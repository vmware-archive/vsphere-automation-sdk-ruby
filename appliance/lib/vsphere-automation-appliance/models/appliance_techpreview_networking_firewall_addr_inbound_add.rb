...
module VSphereAutomation
  module Appliance
    class ApplianceTechpreviewNetworkingFirewallAddrInboundAdd
    ...
    def self.openapi_types
      {
        :'pos' => :'Integer',
        :'rule' => :'ApplianceTechpreviewNetworkingFirewallAddrInboundFirewallAddressRule'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @pos.nil?
        invalid_properties.push('invalid value for "pos", pos cannot be nil.')
      end
