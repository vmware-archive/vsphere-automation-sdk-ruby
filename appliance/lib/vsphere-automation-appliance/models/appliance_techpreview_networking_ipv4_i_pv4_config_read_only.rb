...
module VSphereAutomation
  module Appliance
    class ApplianceTechpreviewNetworkingIpv4IPv4ConfigReadOnly
    ...
    def self.openapi_types
      {
        ...
        :'mode' => :'ApplianceTechpreviewNetworkingIpv4IPv4Mode',
        :'prefix' => :'Integer',
        :'updateable' => :'Boolean'
      }
    end
    ...
    def hash
      [address, default_gateway, interface_name, mode, prefix, updateable].hash
    end
