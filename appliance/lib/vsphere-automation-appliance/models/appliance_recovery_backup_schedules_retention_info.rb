...
module VSphereAutomation
  module Appliance
    class ApplianceRecoveryBackupSchedulesRetentionInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'max_count')
    ...
    def list_invalid_properties
      ...
      if @max_count.nil?
        invalid_properties.push('invalid value for "max_count", max_count cannot be nil.')
      end
