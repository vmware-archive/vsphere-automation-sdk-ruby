...
module VSphereAutomation
  module Appliance
    class ApplianceTechpreviewNetworkingRoutesTestStatusInfo
    # messages
    ...
    def self.openapi_types
      {
        :'messages' => :'Array<ApplianceTechpreviewNetworkingRoutesMessage>',
        :'status' => :'ApplianceTechpreviewNetworkingRoutesTestStatus'
      }
    end
