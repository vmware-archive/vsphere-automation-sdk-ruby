...
module VSphereAutomation
  ...
  class RecoveryApi
    ...
    # Gets the properties of the appliance Recovery subsystem.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceRecoveryResult, Fixnum, Hash)>] ApplianceRecoveryResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceRecoveryResult')
      if @api_client.config.debugging
