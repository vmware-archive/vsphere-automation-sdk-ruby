...
module VSphereAutomation
  ...
  class RecoveryBackupPartsApi
    ...
    # @param id Identifier of the part.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceRecoveryBackupPartsResult, Fixnum, Hash)>] ApplianceRecoveryBackupPartsResult data, response status code and response headers
    def get_with_http_info(id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceRecoveryBackupPartsResult')
      if @api_client.config.debugging
    ...
    # Gets a list of the backup parts.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceRecoveryBackupPartsListResult, Fixnum, Hash)>] ApplianceRecoveryBackupPartsListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Appliance::ApplianceRecoveryBackupPartsListResult')
      if @api_client.config.debugging
