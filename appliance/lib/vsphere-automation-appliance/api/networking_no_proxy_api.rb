...
module VSphereAutomation
  ...
  class NetworkingNoProxyApi
    ...
    # Returns servers for which no proxy configuration will be applied.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceNetworkingNoProxyResult, Fixnum, Hash)>] ApplianceNetworkingNoProxyResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceNetworkingNoProxyResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceNetworkingNoProxySet] :appliance_networking_no_proxy_set 
    # @return [nil]
    def set(opts = {})
    ...
    def set_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_networking_no_proxy_set'])
      auth_names = []
