...
module VSphereAutomation
  ...
  class HealthSoftwarepackagesApi
    ...
    # @return [ApplianceHealthSoftwarepackagesResp|VapiStdErrorsErrorError|]
    def get(opts = {})
    ...
    # @api private
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceHealthSoftwarepackagesResp|VapiStdErrorsErrorError|, Fixnum, Hash)>]  data, response status code and response headers
    def get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: HealthSoftwarepackagesApi.get ...'
      end
      # resource path
      local_var_path = '/rest/appliance/health/software-packages'
	...
	:return_type => {
	  '200' => 'Appliance::ApplianceHealthSoftwarepackagesResp',
