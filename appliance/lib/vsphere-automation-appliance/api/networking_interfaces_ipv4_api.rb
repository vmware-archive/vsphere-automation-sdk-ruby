...
module VSphereAutomation
  ...
  class NetworkingInterfacesIpv4Api
    ...
    # @param interface_name The Network interface to query, for example, \&quot;nic0\&quot;.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceNetworkingInterfacesIpv4Result, Fixnum, Hash)>] ApplianceNetworkingInterfacesIpv4Result data, response status code and response headers
    def get_with_http_info(interface_name, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceNetworkingInterfacesIpv4Result')
      if @api_client.config.debugging
