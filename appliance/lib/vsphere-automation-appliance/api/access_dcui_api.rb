...
module VSphereAutomation
  ...
  class AccessDcuiApi
    ...
    # Get enabled state of Direct Console User Interface (DCUI TTY2).
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceAccessDcuiResult, Fixnum, Hash)>] ApplianceAccessDcuiResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceAccessDcuiResult')
      if @api_client.config.debugging
    ...
    def set_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_access_dcui_set'])
      auth_names = []
