...
module VSphereAutomation
  ...
  class TechpreviewServicesStatusApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceTechpreviewServicesStatusGet] :appliance_techpreview_services_status_get 
    # @return [Array<(ApplianceTechpreviewServicesStatusResult, Fixnum, Hash)>] ApplianceTechpreviewServicesStatusResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceTechpreviewServicesStatusResult')
      if @api_client.config.debugging
