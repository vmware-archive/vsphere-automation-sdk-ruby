...
module VSphereAutomation
  ...
  class VmonServiceApi
    ...
    # @param service identifier of the service whose state is being queried. The parameter must be an identifier for the resource type: appliance.vmon.Service.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceVmonServiceResult, Fixnum, Hash)>] ApplianceVmonServiceResult data, response status code and response headers
    def get_with_http_info(service, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceVmonServiceResult')
      if @api_client.config.debugging
    ...
    # Lists details of services managed by vMon.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceVmonServiceListDetailsResult, Fixnum, Hash)>] ApplianceVmonServiceListDetailsResult data, response status code and response headers
    def list_details_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Appliance::ApplianceVmonServiceListDetailsResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceVmonServiceUpdate] :appliance_vmon_service_update 
    # @return [nil]
    ...
    def update_with_http_info(service, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_vmon_service_update'])
      auth_names = []
