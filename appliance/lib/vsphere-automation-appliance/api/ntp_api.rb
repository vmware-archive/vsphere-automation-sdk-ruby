...
module VSphereAutomation
  ...
  class NtpApi
    ...
    # Get the NTP configuration status. If you run the &#39;timesync.get&#39; command, you can retrieve the current time synchronization method (NTP- or VMware Tools-based). The &#39;ntp&#39; command always returns the NTP server information, even when the time synchronization mode is not set to NTP. If the time synchronization mode is not NTP-based, the NTP server status is displayed as down.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceNtpResult, Fixnum, Hash)>] ApplianceNtpResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceNtpResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceNtpSet] :appliance_ntp_set 
    # @return [nil]
    def set(opts = {})
    ...
    def set_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_ntp_set'])
      auth_names = []
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceNtpTest] :appliance_ntp_test 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceNtpTest] :appliance_ntp_test 
    # @return [Array<(ApplianceNtpTestResult, Fixnum, Hash)>] ApplianceNtpTestResult data, response status code and response headers
    def test_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_ntp_test'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Appliance::ApplianceNtpTestResult')
      if @api_client.config.debugging
