...
module VSphereAutomation
  ...
  class TimesyncApi
    ...
    # @return [ApplianceTimesyncResult|VapiStdErrorsErrorError|]
    def get(opts = {})
	...
	:return_type => {
	  '200' => 'Appliance::ApplianceTimesyncResult',
    ...
    def set(appliance_timesync_set, opts = {})
      set_with_http_info(appliance_timesync_set, opts)
      nil
    end
    ...
    def set_with_http_info(appliance_timesync_set, opts = {})
      ...
      # verify the required parameter 'appliance_timesync_set' is set
      if @api_client.config.client_side_validation && appliance_timesync_set.nil?
        fail ArgumentError, "Missing the required parameter 'appliance_timesync_set' when calling TimesyncApi.set"
      end
      # resource path
      local_var_path = '/appliance/timesync'
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(appliance_timesync_set)
      auth_names = []
