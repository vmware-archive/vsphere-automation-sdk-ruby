...
module VSphereAutomation
  ...
  class AccessSshApi
    ...
    # Get enabled state of the SSH-based controlled CLI.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceAccessSshResult, Fixnum, Hash)>] ApplianceAccessSshResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceAccessSshResult')
      if @api_client.config.debugging
    ...
    def set_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_access_ssh_set'])
      auth_names = []
