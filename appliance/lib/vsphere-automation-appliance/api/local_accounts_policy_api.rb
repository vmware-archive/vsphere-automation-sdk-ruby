...
module VSphereAutomation
  ...
  class LocalAccountsPolicyApi
    ...
    # Get the global password policy.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceLocalAccountsPolicyResult, Fixnum, Hash)>] ApplianceLocalAccountsPolicyResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceLocalAccountsPolicyResult')
      if @api_client.config.debugging
