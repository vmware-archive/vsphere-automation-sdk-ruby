...
module VSphereAutomation
  ...
  class UpdatePolicyApi
    ...
    # Gets the automatic update checking and staging policy.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceUpdatePolicyResult, Fixnum, Hash)>] ApplianceUpdatePolicyResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceUpdatePolicyResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceUpdatePolicySet] :appliance_update_policy_set 
    # @return [nil]
    def set(opts = {})
    ...
    def set_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_update_policy_set'])
      auth_names = []
