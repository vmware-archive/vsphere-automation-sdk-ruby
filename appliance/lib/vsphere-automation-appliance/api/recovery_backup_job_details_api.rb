...
module VSphereAutomation
  ...
  class RecoveryBackupJobDetailsApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :filter_jobs Identifiers of backup jobs that can match the filter.
    # @return [Array<(ApplianceRecoveryBackupJobDetailsListResult, Fixnum, Hash)>] ApplianceRecoveryBackupJobDetailsListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceRecoveryBackupJobDetailsListResult')
      if @api_client.config.debugging
