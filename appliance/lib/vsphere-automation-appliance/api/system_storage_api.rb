...
module VSphereAutomation
  ...
  class SystemStorageApi
    ...
    # Get disk to partition mapping.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceSystemStorageListResult, Fixnum, Hash)>] ApplianceSystemStorageListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceSystemStorageListResult')
      if @api_client.config.debugging
    ...
    # Resize all partitions to 100 percent of disk size.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceSystemStorageResizeExResult, Fixnum, Hash)>] ApplianceSystemStorageResizeExResult data, response status code and response headers
    def resize_ex_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Appliance::ApplianceSystemStorageResizeExResult')
      if @api_client.config.debugging
