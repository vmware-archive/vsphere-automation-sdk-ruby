...
module VSphereAutomation
  ...
  class UpdateApi
    ...
    # Gets the current status of the appliance update.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceUpdateResult, Fixnum, Hash)>] ApplianceUpdateResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Appliance::ApplianceUpdateResult')
      if @api_client.config.debugging
