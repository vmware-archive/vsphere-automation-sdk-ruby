...
module VSphereAutomation
  ...
  class NetworkingFirewallInboundApi
    ...
    # @return [ApplianceNetworkingFirewallInboundResp|VapiStdErrorsErrorError|]
    def get(opts = {})
    ...
    # @api private
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceNetworkingFirewallInboundResp|VapiStdErrorsErrorError|, Fixnum, Hash)>]  data, response status code and response headers
    def get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NetworkingFirewallInboundApi.get ...'
      end
      # resource path
      local_var_path = '/rest/appliance/networking/firewall/inbound'
	...
	:return_type => {
	  '200' => 'Appliance::ApplianceNetworkingFirewallInboundResp',
