...
module VSphereAutomation
  ...
  class NetworkingDnsHostnameApi
    ...
    # Get the Fully Qualified Doman Name.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceNetworkingDnsHostnameResult, Fixnum, Hash)>] ApplianceNetworkingDnsHostnameResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceNetworkingDnsHostnameResult')
      if @api_client.config.debugging
    ...
    def set_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_networking_dns_hostname_set'])
      auth_names = []
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceNetworkingDnsHostnameTest] :appliance_networking_dns_hostname_test 
    # @return [Array<(ApplianceNetworkingDnsHostnameTestResult, Fixnum, Hash)>] ApplianceNetworkingDnsHostnameTestResult data, response status code and response headers
    def test_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_networking_dns_hostname_test'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Appliance::ApplianceNetworkingDnsHostnameTestResult')
      if @api_client.config.debugging
