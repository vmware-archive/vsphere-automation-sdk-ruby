...
module VSphereAutomation
  ...
  class RecoveryBackupSystemNameApi
    ...
    # Returns a list of system names for which backup archives exist under {@param.name locSpec}.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceRecoveryBackupSystemNameListResult, Fixnum, Hash)>] ApplianceRecoveryBackupSystemNameListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceRecoveryBackupSystemNameListResult')
      if @api_client.config.debugging
