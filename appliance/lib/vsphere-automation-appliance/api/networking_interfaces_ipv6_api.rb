...
module VSphereAutomation
  ...
  class NetworkingInterfacesIpv6Api
    ...
    # @param interface_name Network interface to query, for example, \&quot;nic0\&quot;.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceNetworkingInterfacesIpv6Result, Fixnum, Hash)>] ApplianceNetworkingInterfacesIpv6Result data, response status code and response headers
    def get_with_http_info(interface_name, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceNetworkingInterfacesIpv6Result')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceNetworkingInterfacesIpv6Set] :appliance_networking_interfaces_ipv6_set 
    # @return [nil]
    ...
    def set_with_http_info(interface_name, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_networking_interfaces_ipv6_set'])
      auth_names = []
