...
module VSphereAutomation
  ...
  class SystemTimeTimezoneApi
    ...
    # Get time zone.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceSystemTimeTimezoneResult, Fixnum, Hash)>] ApplianceSystemTimeTimezoneResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceSystemTimeTimezoneResult')
      if @api_client.config.debugging
    ...
    def set_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_system_time_timezone_set'])
      auth_names = []
