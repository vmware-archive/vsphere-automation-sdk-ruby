...
module VSphereAutomation
  ...
  class RecoveryRestoreApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceRecoveryRestoreValidate] :appliance_recovery_restore_validate 
    # @return [Array<(ApplianceRecoveryRestoreValidateResult, Fixnum, Hash)>] ApplianceRecoveryRestoreValidateResult data, response status code and response headers
    def validate_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceRecoveryRestoreValidateResult')
      if @api_client.config.debugging
