...
module VSphereAutomation
  ...
  class NetworkingProxyApi
    ...
    # @param protocol The protocol whose proxy configuration is requested.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceNetworkingProxyResult, Fixnum, Hash)>] ApplianceNetworkingProxyResult data, response status code and response headers
    def get_with_http_info(protocol, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Appliance::ApplianceNetworkingProxyResult')
      if @api_client.config.debugging
    ...
    # Gets proxy configuration for all configured protocols.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceNetworkingProxyListResult, Fixnum, Hash)>] ApplianceNetworkingProxyListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Appliance::ApplianceNetworkingProxyListResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceNetworkingProxySet] :appliance_networking_proxy_set 
    # @return [nil]
    def set(protocol, opts = {})
      set_with_http_info(protocol, opts)
      nil
    end
    ...
    # @option opts [ApplianceNetworkingProxySet] :appliance_networking_proxy_set 
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def set_with_http_info(protocol, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_networking_proxy_set'])
      auth_names = []
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceNetworkingProxyTest] :appliance_networking_proxy_test 
    # @return [ApplianceNetworkingProxyTestResult]
    def test(protocol, opts = {})
      data, _status_code, _headers = test_with_http_info(protocol, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ApplianceNetworkingProxyTest] :appliance_networking_proxy_test 
    # @return [Array<(ApplianceNetworkingProxyTestResult, Fixnum, Hash)>] ApplianceNetworkingProxyTestResult data, response status code and response headers
    def test_with_http_info(protocol, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'appliance_networking_proxy_test'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Appliance::ApplianceNetworkingProxyTestResult')
      if @api_client.config.debugging
