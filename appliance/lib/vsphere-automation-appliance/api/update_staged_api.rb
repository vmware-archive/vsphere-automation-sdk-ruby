...
module VSphereAutomation
  ...
  class UpdateStagedApi
    ...
    # Gets the current status of the staged update
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceUpdateStagedResult, Fixnum, Hash)>] ApplianceUpdateStagedResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Appliance::ApplianceUpdateStagedResult')
      if @api_client.config.debugging
