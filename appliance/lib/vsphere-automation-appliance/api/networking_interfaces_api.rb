...
module VSphereAutomation
  ...
  class NetworkingInterfacesApi
    ...
    # @param interface_name Network interface, for example, \&quot;nic0\&quot;.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceNetworkingInterfacesResult, Fixnum, Hash)>] ApplianceNetworkingInterfacesResult data, response status code and response headers
    def get_with_http_info(interface_name, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Appliance::ApplianceNetworkingInterfacesResult')
      if @api_client.config.debugging
    ...
    # Get list of available network interfaces, including those that are not yet configured.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApplianceNetworkingInterfacesListResult, Fixnum, Hash)>] ApplianceNetworkingInterfacesListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Appliance::ApplianceNetworkingInterfacesListResult')
      if @api_client.config.debugging
