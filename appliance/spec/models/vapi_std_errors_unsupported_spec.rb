...
# Unit tests for VSphereAutomation::Appliance::VapiStdErrorsUnsupported
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VapiStdErrorsUnsupported' do
  before do
    # run before each test
    @instance = VSphereAutomation::Appliance::VapiStdErrorsUnsupported.new
  end
  ...
  describe 'test an instance of VapiStdErrorsUnsupported' do
    it 'should create an instance of VapiStdErrorsUnsupported' do
      expect(@instance).to be_instance_of(VSphereAutomation::Appliance::VapiStdErrorsUnsupported)
    end
  end
