...
# Unit tests for VSphereAutomation::Appliance::VapiStdLocalizableMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VapiStdLocalizableMessage' do
  before do
    # run before each test
    @instance = VSphereAutomation::Appliance::VapiStdLocalizableMessage.new
  end
  ...
  describe 'test an instance of VapiStdLocalizableMessage' do
    it 'should create an instance of VapiStdLocalizableMessage' do
      expect(@instance).to be_instance_of(VSphereAutomation::Appliance::VapiStdLocalizableMessage)
    end
  end
