...
# Unit tests for VSphereAutomation::VStats::ManagementApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ManagementApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::VStats::ManagementApi.new
  end
  ...
  describe 'test an instance of ManagementApi' do
    it 'should create an instance of ManagementApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::VStats::ManagementApi)
    end
  end
