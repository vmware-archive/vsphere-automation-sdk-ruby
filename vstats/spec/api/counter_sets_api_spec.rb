...
# Unit tests for VSphereAutomation::VStats::CounterSetsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CounterSetsApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::VStats::CounterSetsApi.new
  end
  ...
  describe 'test an instance of CounterSetsApi' do
    it 'should create an instance of CounterSetsApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::VStats::CounterSetsApi)
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @return [Array<VstatsCounterSetsInfo>]
