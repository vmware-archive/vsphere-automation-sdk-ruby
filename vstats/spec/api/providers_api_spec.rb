...
# Unit tests for VSphereAutomation::VStats::ProvidersApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProvidersApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::VStats::ProvidersApi.new
  end
  ...
  describe 'test an instance of ProvidersApi' do
    it 'should create an instance of ProvidersApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::VStats::ProvidersApi)
    end
  end
  ...
  # @return [Array<VstatsProvidersSummary>]
