...
# Unit tests for VSphereAutomation::VStats::MetricsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'MetricsApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::VStats::MetricsApi.new
  end
  ...
  describe 'test an instance of MetricsApi' do
    it 'should create an instance of MetricsApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::VStats::MetricsApi)
    end
  end
  ...
  # @return [Array<VstatsMetricsSummary>]
