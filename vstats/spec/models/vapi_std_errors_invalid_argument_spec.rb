...
# Unit tests for VSphereAutomation::VStats::VapiStdErrorsInvalidArgument
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VapiStdErrorsInvalidArgument' do
  before do
    # run before each test
    @instance = VSphereAutomation::VStats::VapiStdErrorsInvalidArgument.new
  end
  ...
  describe 'test an instance of VapiStdErrorsInvalidArgument' do
    it 'should create an instance of VapiStdErrorsInvalidArgument' do
      expect(@instance).to be_instance_of(VSphereAutomation::VStats::VapiStdErrorsInvalidArgument)
    end
  end
