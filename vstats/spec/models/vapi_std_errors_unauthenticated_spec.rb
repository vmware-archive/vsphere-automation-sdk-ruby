...
# Unit tests for VSphereAutomation::VStats::VapiStdErrorsUnauthenticated
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VapiStdErrorsUnauthenticated' do
  before do
    # run before each test
    @instance = VSphereAutomation::VStats::VapiStdErrorsUnauthenticated.new
  end
  ...
  describe 'test an instance of VapiStdErrorsUnauthenticated' do
    it 'should create an instance of VapiStdErrorsUnauthenticated' do
      expect(@instance).to be_instance_of(VSphereAutomation::VStats::VapiStdErrorsUnauthenticated)
    end
  end
