...
module VSphereAutomation
  module VStats
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tracking_sn')
        self.tracking_sn = attributes[:'tracking_sn']
      end
    ...
    def hash
      [id, id_value, metadata, scheme, tracking_sn, type].hash
    end
