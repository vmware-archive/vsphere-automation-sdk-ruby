...
module VSphereAutomation
  module VStats
    class VstatsAcqSpecsListResult
    ...
    def self.openapi_types
      {
        :'acq_specs' => :'Array<VstatsAcqSpecsInfo>',
        :'_next' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'acq_specs')
        if (value = attributes[:'acq_specs']).is_a?(Array)
          self.acq_specs = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @acq_specs.nil?
        invalid_properties.push('invalid value for "acq_specs", acq_specs cannot be nil.')
      end
