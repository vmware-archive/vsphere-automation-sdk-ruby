...
module VSphereAutomation
  module VStats
    ...
    # The reason explaining why the status of an Acquisition Specification is either DISABLED, INVALID or EXPIRED. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. If unset, it means status is ENABLED.
    ...
    def self.openapi_types
      {
        :'counters' => :'VstatsAcqSpecsCounterSpec',
        :'endpoints' => :'Array<String>',
        :'expiration' => :'Integer',
        :'id' => :'String',
        :'interval' => :'Integer',
        :'memo_' => :'String',
        :'resources' => :'Array<VstatsRsrcId>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'memo_')
        self.memo_ = attributes[:'memo_']
      end
    ...
    def list_invalid_properties
      ...
      if @memo_.nil?
        invalid_properties.push('invalid value for "memo_", memo_ cannot be nil.')
      end
    ...
    def hash
      [counters, endpoints, expiration, id, interval, memo_, resources, status, status_reason].hash
    end
