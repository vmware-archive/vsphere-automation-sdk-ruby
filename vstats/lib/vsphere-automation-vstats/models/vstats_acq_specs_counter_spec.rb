...
module VSphereAutomation
  module VStats
    class VstatsAcqSpecsCounterSpec
    attr_accessor :cid_mid
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cid_mid')
        self.cid_mid = attributes[:'cid_mid']
      end

      if attributes.has_key?(:'set_id')
