...
module VSphereAutomation
  module VStats
    ...
    attr_accessor :resource_address_schema
    ...
    def self.attribute_map
      {
        :'cid' => :'cid',
        :'metric' => :'metric',
        :'resource_address_schema' => :'resource_address_schema'
      }
    end
    ...
    def self.openapi_types
      {
        :'cid' => :'String',
        :'metric' => :'String',
        :'resource_address_schema' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'resource_address_schema')
        self.resource_address_schema = attributes[:'resource_address_schema']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @resource_address_schema.nil?
        invalid_properties.push('invalid value for "resource_address_schema", resource_address_schema cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @resource_address_schema.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          cid == o.cid &&
          metric == o.metric &&
          resource_address_schema == o.resource_address_schema
    end
    ...
    def hash
      [cid, metric, resource_address_schema].hash
    end
