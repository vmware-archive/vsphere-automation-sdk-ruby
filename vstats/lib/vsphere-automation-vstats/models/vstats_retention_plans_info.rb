...
module VSphereAutomation
  module VStats
    class VstatsRetentionPlansInfo
    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'max_ages' => :'VstatsRetentionPlansMaxAgesInfo',
        :'memo_' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'max_ages')
        self.max_ages = attributes[:'max_ages']
      end
    ...
    def list_invalid_properties
      ...
      if @max_ages.nil?
        invalid_properties.push('invalid value for "max_ages", max_ages cannot be nil.')
      end
