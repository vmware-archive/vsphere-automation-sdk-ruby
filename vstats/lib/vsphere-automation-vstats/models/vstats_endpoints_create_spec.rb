...
module VSphereAutomation
  module VStats
    class VstatsEndpointsCreateSpec
    ...
    # Designates the port of an endpoint. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. If unset, no port will be provided.
    attr_accessor :port
    ...
    def hash
      [auth_data, name, port, push_data_format, uri].hash
    end
