...
module VSphereAutomation
  module VStats
    class VstatsResourceAddressesListResult
    ...
    attr_accessor :rsrc_addrs

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'_next' => :'next',
        :'rsrc_addrs' => :'rsrc_addrs'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rsrc_addrs')
        if (value = attributes[:'rsrc_addrs']).is_a?(Array)
          self.rsrc_addrs = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @rsrc_addrs.nil?
        invalid_properties.push('invalid value for "rsrc_addrs", rsrc_addrs cannot be nil.')
      end
    ...
    def valid?
      return false if @rsrc_addrs.nil?
      true
    end
