...
module VSphereAutomation
  module VStats
    ...
    def list_invalid_properties
      ...
      if @data_format.nil?
        invalid_properties.push('invalid value for "data_format", data_format cannot be nil.')
      end
