...
module VSphereAutomation
  module VStats
    class VstatsResourceAddressSchemasInfo
    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'schema' => :'Array<VstatsResourceAddressSchemasResourceIdDefinition>'
      }
    end
