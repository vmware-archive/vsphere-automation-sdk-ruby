...
module VSphereAutomation
  module VCenter
    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'status' => :'VcenterLcmTaskInfo',
        :'task' => :'String',
        :'type' => :'VcenterLcmTasksOperation'
      }
    end
