...
module VSphereAutomation
  module VCenter
    class VcenterNsxEdgeClustersManagementNetworkInfo
    ...
    # Name of the network. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. To be unset when name of EdgeClusters.ManagementNetworkInfo.network could not be fetched.
    ...
    def hash
      [gateway, network, network_name, subnet_mask].hash
    end
