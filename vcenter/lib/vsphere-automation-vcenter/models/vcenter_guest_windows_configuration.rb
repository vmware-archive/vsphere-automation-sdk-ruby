...
module VSphereAutomation
  module VCenter
    class VcenterGuestWindowsConfiguration
    ...
    def self.openapi_types
      {
        :'reboot' => :'VcenterGuestWindowsConfigurationRebootOption',
        :'sysprep' => :'VcenterGuestWindowsSysprep',
        :'sysprep_xml' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reboot')
        self.reboot = attributes[:'reboot']
      end

      if attributes.has_key?(:'sysprep')
        self.sysprep = attributes[:'sysprep']
      end

      if attributes.has_key?(:'sysprep_xml')
        self.sysprep_xml = attributes[:'sysprep_xml']
      end
    end
    ...
    def hash
      [reboot, sysprep, sysprep_xml].hash
    end
