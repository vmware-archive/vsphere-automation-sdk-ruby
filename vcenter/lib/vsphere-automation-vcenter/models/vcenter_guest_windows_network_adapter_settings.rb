...
module VSphereAutomation
  module VCenter
    class VcenterGuestWindowsNetworkAdapterSettings
    ...
    def self.openapi_types
      {
        ...
        :'net_bios_mode' => :'VcenterGuestWindowsNetworkAdapterSettingsNetBIOSMode',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dns_domain')
      ...
      if attributes.has_key?(:'net_BIOS_mode')
        self.net_bios_mode = attributes[:'net_BIOS_mode']
      end
    ...
    def hash
      [dns_domain, dns_servers, net_bios_mode, wins_servers].hash
    end
