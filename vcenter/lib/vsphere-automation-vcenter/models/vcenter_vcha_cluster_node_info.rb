...
module VSphereAutomation
  module VCenter
    class VcenterVchaClusterNodeInfo
    ...
    def self.openapi_types
      {
        :'failover_ip' => :'VcenterVchaClusterIpInfo',
        :'ha_ip' => :'VcenterVchaClusterIpInfo',
        :'runtime' => :'VcenterVchaClusterNodeRuntimeInfo'
      }
    end
    ...
    def hash
      [failover_ip, ha_ip, runtime].hash
    end
