...
module VSphereAutomation
  module VCenter
    class VcenterGuestHostnameGenerator
    ...
    def self.openapi_types
      {
        :'fixed_name' => :'String',
        :'prefix' => :'String',
        :'type' => :'VcenterGuestHostnameGeneratorType'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fixed_name')
        self.fixed_name = attributes[:'fixed_name']
      end
