...
module VSphereAutomation
  module VCenter
    ...
    def self.openapi_types
      {
        :'computer_name' => :'VcenterGuestHostnameGenerator',
        :'full_name' => :'String',
        :'organization' => :'String',
        :'product_key' => :'String'
      }
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'product_key')
    ...
    def hash
      [computer_name, full_name, organization, product_key].hash
    end
