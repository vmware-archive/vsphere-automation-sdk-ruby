...
module VSphereAutomation
  module VCenter
    class VcenterLcmUpdatePendingInfo
    ...
    def hash
      [build, category, description, execute_url, pending_update, reboot_required, release_date, release_notes, severity, update_type, version].hash
    end
