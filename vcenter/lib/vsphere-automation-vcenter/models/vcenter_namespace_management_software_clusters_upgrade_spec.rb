...
module VSphereAutomation
  module VCenter
    class VcenterNamespaceManagementSoftwareClustersUpgradeSpec
    ...
    attr_accessor :ignore_precheck_warnings

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'desired_version' => :'desired_version',
        :'ignore_precheck_warnings' => :'ignore_precheck_warnings'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'ignore_precheck_warnings' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ignore_precheck_warnings')
        self.ignore_precheck_warnings = attributes[:'ignore_precheck_warnings']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @desired_version.nil?
        invalid_properties.push('invalid value for "desired_version", desired_version cannot be nil.')
      end
    ...
    def valid?
      return false if @desired_version.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ignore_precheck_warnings == o.ignore_precheck_warnings
    end
    ...
    def hash
      [desired_version, ignore_precheck_warnings].hash
    end
