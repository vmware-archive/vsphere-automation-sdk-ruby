...
module VSphereAutomation
  module VCenter
    class VcenterVmGuestFilesystemTransfersFileAttributesCreateSpec
    ...
    def self.openapi_types
      {
        ...
        :'posix' => :'VcenterVmGuestFilesystemTransfersPosixFileAttributesCreateSpec',
        :'windows' => :'VcenterVmGuestFilesystemTransfersWindowsFileAttributesCreateSpec'
      }
    end
