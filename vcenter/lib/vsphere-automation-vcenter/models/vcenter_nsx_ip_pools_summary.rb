...
module VSphereAutomation
  module VCenter
    ...
    def list_invalid_properties
      ...
      if @ip_pool.nil?
        invalid_properties.push('invalid value for "ip_pool", ip_pool cannot be nil.')
      end
