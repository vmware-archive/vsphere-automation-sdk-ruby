...
module VSphereAutomation
  module VCenter
    class VcenterTrustedInfrastructureTrustAuthorityClustersKmsProvidersUpdateSpec
    ...
    def self.openapi_types
      {
        :'key_server' => :'VcenterTrustedInfrastructureTrustAuthorityClustersKmsProvidersKeyServerUpdateSpec',
