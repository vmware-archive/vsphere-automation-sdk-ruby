...
module VSphereAutomation
  module VCenter
    class VcenterVmGuestNetworkingInterfacesIpConfigInfo
    attr_accessor :dhcp
    ...
    def self.openapi_types
      {
        :'dhcp' => :'VcenterVmGuestDhcpConfigInfo',
        :'ip_addresses' => :'Array<VcenterVmGuestNetworkingInterfacesIpAddressInfo>'
      }
    end
