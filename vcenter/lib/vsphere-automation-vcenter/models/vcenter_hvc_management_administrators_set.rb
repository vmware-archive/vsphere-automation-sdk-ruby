...
module VSphereAutomation
  module VCenter
    class VcenterHvcManagementAdministratorsSet
    ...
    def list_invalid_properties
      ...
      if @group_names.nil?
        invalid_properties.push('invalid value for "group_names", group_names cannot be nil.')
      end
    ...
    def valid?
      return false if @group_names.nil?
      true
    end
