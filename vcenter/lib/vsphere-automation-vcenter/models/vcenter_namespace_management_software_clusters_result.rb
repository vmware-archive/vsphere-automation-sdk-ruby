...
module VSphereAutomation
  module VCenter
    class VcenterNamespaceManagementSoftwareClustersResult
    ...
    def self.openapi_types
      {
        :'exception' => :'String',
        :'res' => :'VcenterNamespaceManagementSoftwareClustersResultRes'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @res.nil?
        invalid_properties.push('invalid value for "res", res cannot be nil.')
      end
