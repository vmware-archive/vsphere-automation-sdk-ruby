...
module VSphereAutomation
  module VCenter
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'path' => :'String',
        :'placement' => :'VcenterVMRegisterPlacementSpec'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'datastore_path')
        self.datastore_path = attributes[:'datastore_path']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          datastore_path == o.datastore_path &&
          name == o.name &&
          path == o.path &&
    ...
    def hash
      [datastore, datastore_path, name, path, placement].hash
    end
