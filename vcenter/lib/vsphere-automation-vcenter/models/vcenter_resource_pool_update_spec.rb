...
module VSphereAutomation
  module VCenter
    class VcenterResourcePoolUpdateSpec
    ...
    def self.openapi_types
      {
        :'cpu_allocation' => :'VcenterResourcePoolResourceAllocationUpdateSpec',
        :'memory_allocation' => :'VcenterResourcePoolResourceAllocationUpdateSpec',
        :'name' => :'String'
      }
    end
    ...
    def hash
      [cpu_allocation, memory_allocation, name].hash
    end
