...
module VSphereAutomation
  module VCenter
    class VcenterServicesServiceInfo
    ...
    def self.openapi_types
      {
        ...
        :'startup_type' => :'VcenterServicesServiceStartupType',
        :'state' => :'VcenterServicesServiceState',
        :'health' => :'VcenterServicesServiceHealth',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'health_messages')
        if (value = attributes[:'health_messages']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @startup_type.nil?
        invalid_properties.push('invalid value for "startup_type", startup_type cannot be nil.')
      end
