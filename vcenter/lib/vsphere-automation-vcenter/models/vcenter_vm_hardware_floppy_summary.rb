...
module VSphereAutomation
  module VCenter
    class VcenterVmHardwareFloppySummary
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'floppy')
        self.floppy = attributes[:'floppy']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @floppy.nil?
        invalid_properties.push('invalid value for "floppy", floppy cannot be nil.')
      end
