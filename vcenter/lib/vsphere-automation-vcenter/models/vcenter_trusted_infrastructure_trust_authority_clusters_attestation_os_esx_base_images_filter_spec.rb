...
module VSphereAutomation
  module VCenter
    class VcenterTrustedInfrastructureTrustAuthorityClustersAttestationOsEsxBaseImagesFilterSpec
    ...
    def self.openapi_types
      {
        ...
        :'health' => :'Array<VcenterTrustedInfrastructureTrustAuthorityClustersAttestationOsEsxBaseImagesHealth>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'version')
        if (value = attributes[:'version']).is_a?(Array)
          self.version = value
        end
      end
    end
    ...
    def hash
      [display_name, health, version].hash
    end
