...
module VSphereAutomation
  module VCenter
    ...
    # The network of the ESX host to which the new appliance should connect. Omit this parameter if the ESX host has one network. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. If unset, defaults to VM Network
    attr_accessor :network_name

    # The path to the resource pool on the ESX host in which the appliance will be deployed. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. Not applicable when not in resource pool
    ...
    def hash
      [datastore_name, network_name, resource_pool_path].hash
    end
