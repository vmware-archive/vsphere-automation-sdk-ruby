...
module VSphereAutomation
  module VCenter
    ...
    def self.openapi_types
      {
        :'loss' => :'VcenterNsxRecoveryLossType',
        :'needed' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'loss')
        self.loss = attributes[:'loss']
      end

      if attributes.has_key?(:'needed')
    ...
    def list_invalid_properties
      ...
      if @needed.nil?
        invalid_properties.push('invalid value for "needed", needed cannot be nil.')
      end
