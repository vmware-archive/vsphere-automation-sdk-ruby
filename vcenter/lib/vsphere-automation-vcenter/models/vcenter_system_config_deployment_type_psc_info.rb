...
module VSphereAutomation
  module VCenter
    class VcenterSystemConfigDeploymentTypePscInfo
    ...
    attr_accessor :skip_ad_domain_join

    attr_accessor :ad_domain
    ...
    def self.attribute_map
      {
        ...
        :'skip_ad_domain_join' => :'skip_ad_domain_join',
        :'ad_domain' => :'ad_domain'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'skip_ad_domain_join' => :'Boolean',
        :'ad_domain' => :'VcenterSystemConfigDeploymentTypeDomainInfo'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'skip_ad_domain_join')
        self.skip_ad_domain_join = attributes[:'skip_ad_domain_join']
      end

      if attributes.has_key?(:'ad_domain')
        self.ad_domain = attributes[:'ad_domain']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          skip_ad_domain_join == o.skip_ad_domain_join &&
          ad_domain == o.ad_domain
    end
    ...
    def hash
      [sso_admin_username, sso_admin_password, skip_ad_domain_join, ad_domain].hash
    end
