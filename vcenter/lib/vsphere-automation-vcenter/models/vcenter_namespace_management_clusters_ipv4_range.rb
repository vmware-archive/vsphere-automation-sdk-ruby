...
module VSphereAutomation
  module VCenter
    class VcenterNamespaceManagementClustersIpv4Range
    ...
    def list_invalid_properties
      ...
      if @address_count.nil?
        invalid_properties.push('invalid value for "address_count", address_count cannot be nil.')
      end
    ...
    def valid?
      return false if @address_count.nil?
    ...
    def hash
      [address_count, gateway, starting_address, subnet_mask].hash
    end
