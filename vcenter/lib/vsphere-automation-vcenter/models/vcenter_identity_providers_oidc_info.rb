...
module VSphereAutomation
  module VCenter
    class VcenterIdentityProvidersOidcInfo
    ...
    def list_invalid_properties
      ...
      if @claim_map.nil?
        invalid_properties.push('invalid value for "claim_map", claim_map cannot be nil.')
      end
      ...
      if @discovery_endpoint.nil?
        invalid_properties.push('invalid value for "discovery_endpoint", discovery_endpoint cannot be nil.')
      end
      ...
      if @public_key_uri.nil?
        invalid_properties.push('invalid value for "public_key_uri", public_key_uri cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @claim_map.nil?
      return false if @client_id.nil?
      return false if @client_secret.nil?
      return false if @discovery_endpoint.nil?
      return false if @issuer.nil?
      return false if @public_key_uri.nil?
    ...
    def hash
      [auth_endpoint, auth_query_params, authentication_method, claim_map, client_id, client_secret, discovery_endpoint, issuer, logout_endpoint, public_key_uri, token_endpoint].hash
    end
