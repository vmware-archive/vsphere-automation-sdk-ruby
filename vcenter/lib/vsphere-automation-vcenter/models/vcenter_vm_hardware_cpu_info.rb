...
module VSphereAutomation
  module VCenter
    class VcenterVmHardwareCpuInfo
    # Number of CPU cores.
    attr_accessor :count
    ...
    attr_accessor :hot_remove_enabled
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hot_remove_enabled')
        self.hot_remove_enabled = attributes[:'hot_remove_enabled']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @hot_remove_enabled.nil?
        invalid_properties.push('invalid value for "hot_remove_enabled", hot_remove_enabled cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @hot_remove_enabled.nil?
      true
    end
