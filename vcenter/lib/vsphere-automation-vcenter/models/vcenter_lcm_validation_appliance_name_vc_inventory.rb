...
module VSphereAutomation
  module VCenter
    class VcenterLcmValidationApplianceNameVcInventory
    ...
    # Full path to an ESX host. Format: /{datacenter folder}/{datacenter name}/host/{host name}. e.g: /Your Datacenter Folder/Your Datacenter/host/Your Host. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. Mutually exclusive between #resource_pool_path, #cluster_path, and #host_path
    ...
    def hash
      [cluster_path, host_path, resource_pool_path, vm_folder_path].hash
    end
