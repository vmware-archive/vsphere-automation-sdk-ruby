...
module VSphereAutomation
  module VCenter
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'command_line_options')
        self.command_line_options = attributes[:'command_line_options']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          command_line_options == o.command_line_options
    end
