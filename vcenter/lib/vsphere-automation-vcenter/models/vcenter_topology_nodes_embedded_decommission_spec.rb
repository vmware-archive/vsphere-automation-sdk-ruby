...
module VSphereAutomation
  module VCenter
    class VcenterTopologyNodesEmbeddedDecommissionSpec
    # SHA1 thumbprint of the vCenter Server node to be decommissioned that will be used for verification. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    ...
    # The SSO administrator account password. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    attr_accessor :sso_admin_password

    # The SSO administrator username for example \"administrator@vsphere.local\" Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    ...
    def hash
      [ssl_thumbprint, ssl_verify, sso_admin_password, sso_admin_username].hash
    end
