...
module VSphereAutomation
  module VCenter
    class VcenterTrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsFilterSpec
    ...
    def self.openapi_types
      {
        :'id' => :'Array<String>',
        :'issuer' => :'Array<String>',
        :'principals' => :'Array<VcenterTrustedInfrastructureStsPrincipal>'
      }
    end
