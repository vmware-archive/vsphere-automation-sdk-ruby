...
module VSphereAutomation
  module VCenter
    class VcenterNamespacesInstancesAccess
    ...
    def self.openapi_types
      {
        :'domain' => :'String',
        :'role' => :'VcenterNamespacesAccessRole',
        :'subject' => :'String',
        :'subject_type' => :'VcenterNamespacesAccessSubjectType'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'subject_type')
    ...
    def hash
      [domain, role, subject, subject_type].hash
    end
