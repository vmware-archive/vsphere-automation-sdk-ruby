...
module VSphereAutomation
  module VCenter
    class VcenterNamespacesEventsEventsEvent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'last_time_stamp')
        self.last_time_stamp = attributes[:'last_time_stamp']
      end
    ...
    def list_invalid_properties
      ...
      if @last_time_stamp.nil?
        invalid_properties.push('invalid value for "last_time_stamp", last_time_stamp cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @last_time_stamp.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          count == o.count &&
          kind == o.kind &&
          last_time_stamp == o.last_time_stamp &&
          message == o.message &&
          name == o.name &&
          reason == o.reason &&
          type == o.type
    ...
    def hash
      [component, count, kind, last_time_stamp, message, name, reason, type].hash
    end
