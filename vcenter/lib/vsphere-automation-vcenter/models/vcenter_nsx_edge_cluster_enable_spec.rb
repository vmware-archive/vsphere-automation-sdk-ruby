...
module VSphereAutomation
  module VCenter
    class VcenterNsxEdgeClusterEnableSpec
    ...
    attr_accessor :overlay_network

    attr_accessor :placement

    attr_accessor :uplink_network
    ...
    def self.openapi_types
      {
        :'edge_nodes' => :'Array<VcenterNsxUplinkNodeSpec>',
        :'management_network' => :'VcenterNsxManagementNetworkSpec',
        :'overlay_network' => :'VcenterNsxEdgeOverlayNetworkSpec',
        :'placement' => :'VcenterNsxPlacementSpec',
        :'uplink_network' => :'VcenterNsxUplinkNetworkSpec'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'overlay_network')
        self.overlay_network = attributes[:'overlay_network']
      end
      ...
      if attributes.has_key?(:'uplink_network')
        self.uplink_network = attributes[:'uplink_network']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @overlay_network.nil?
        invalid_properties.push('invalid value for "overlay_network", overlay_network cannot be nil.')
      end
      ...
      if @uplink_network.nil?
        invalid_properties.push('invalid value for "uplink_network", uplink_network cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @overlay_network.nil?
      return false if @placement.nil?
      return false if @uplink_network.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          overlay_network == o.overlay_network &&
          placement == o.placement &&
          uplink_network == o.uplink_network
    end
    ...
    def hash
      [edge_nodes, management_network, overlay_network, placement, uplink_network].hash
    end
