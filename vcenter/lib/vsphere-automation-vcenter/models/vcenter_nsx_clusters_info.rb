...
module VSphereAutomation
  module VCenter
    ...
    def self.openapi_types
      {
        ...
        :'overlay_network_info' => :'VcenterNsxClustersClusterOverlayNetworkInfo'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dv_switch_name')
        self.dv_switch_name = attributes[:'dv_switch_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dv_switch_name == o.dv_switch_name &&
    ...
    def hash
      [dv_switch, dv_switch_name, overlay_network_info].hash
    end
