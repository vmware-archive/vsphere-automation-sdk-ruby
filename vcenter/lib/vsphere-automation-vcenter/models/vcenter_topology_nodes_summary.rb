...
module VSphereAutomation
  module VCenter
    class VcenterTopologyNodesSummary
    ...
    def self.attribute_map
      {
        ...
        :'node' => :'node',
        :'replication_partners' => :'replication_partners',
        :'type' => :'type'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'node' => :'String',
        :'replication_partners' => :'Array<String>',
        :'type' => :'VcenterTopologyNodesApplianceType'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'client_affinity')
        self.client_affinity = attributes[:'client_affinity']
      end
      ...
      if attributes.has_key?(:'replication_partners')
        if (value = attributes[:'replication_partners']).is_a?(Array)
          self.replication_partners = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          client_affinity == o.client_affinity &&
          node == o.node &&
          replication_partners == o.replication_partners &&
          type == o.type
    end
    ...
    def hash
      [client_affinity, node, replication_partners, type].hash
    end
