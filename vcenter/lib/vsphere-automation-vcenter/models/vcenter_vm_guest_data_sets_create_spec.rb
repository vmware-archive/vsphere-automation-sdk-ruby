...
module VSphereAutomation
  module VCenter
    class VcenterVmGuestDataSetsCreateSpec
    ...
    def hash
      [description, disk_mode, guest, host, name, persist, size].hash
    end
