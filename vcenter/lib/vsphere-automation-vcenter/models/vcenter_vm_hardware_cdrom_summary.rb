...
module VSphereAutomation
  module VCenter
    class VcenterVmHardwareCdromSummary
    ...
    def list_invalid_properties
      ...
      if @cdrom.nil?
        invalid_properties.push('invalid value for "cdrom", cdrom cannot be nil.')
      end
