...
module VSphereAutomation
  module VCenter
    ...
    def self.openapi_types
      {
        ...
        :'nvme_adapters' => :'Array<VcenterVmHardwareAdapterNvmeCreateSpec>',
    ...
    def hash
      [boot, boot_devices, cdroms, cpu, disks, floppies, guest_os, hardware_version, memory, name, nics, nvme_adapters, parallel_ports, placement, sata_adapters, scsi_adapters, serial_ports, storage_policy].hash
    end
