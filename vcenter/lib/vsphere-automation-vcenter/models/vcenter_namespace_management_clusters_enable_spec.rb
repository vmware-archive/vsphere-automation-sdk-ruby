...
module VSphereAutomation
  module VCenter
    class VcenterNamespaceManagementClustersEnableSpec
    ...
    attr_accessor :master_dns_names
    ...
    attr_accessor :master_management_network
    ...
    attr_accessor :nsx_deployment

    attr_accessor :nsx_enable_spec
    ...
    def self.attribute_map
      {
        ...
        :'master_management_network' => :'master_management_network',
        :'master_storage_policy' => :'master_storage_policy',
        :'ncp_cluster_network_spec' => :'ncp_cluster_network_spec',
        :'network_provider' => :'network_provider',
        :'nsx_deployment' => :'nsx_deployment',
        :'nsx_enable_spec' => :'nsx_enable_spec',
    ...
    def self.openapi_types
      {
        ...
        :'master_management_network' => :'VcenterNamespaceManagementClustersNetworkSpec',
        :'master_storage_policy' => :'String',
        :'ncp_cluster_network_spec' => :'VcenterNamespaceManagementClustersNCPClusterNetworkEnableSpec',
        :'network_provider' => :'VcenterNamespaceManagementClustersNetworkProvider',
        :'nsx_deployment' => :'VcenterNamespaceManagementClustersNSXDeployment',
        :'nsx_enable_spec' => :'VcenterNsxNSXEnableSpec',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Master_DNS_names')
        if (value = attributes[:'Master_DNS_names']).is_a?(Array)
          self.master_dns_names = value
        end
      end
      ...
      if attributes.has_key?(:'master_management_network')
        self.master_management_network = attributes[:'master_management_network']
      end
      ...
      if attributes.has_key?(:'nsx_deployment')
        self.nsx_deployment = attributes[:'nsx_deployment']
      end

      if attributes.has_key?(:'nsx_enable_spec')
        self.nsx_enable_spec = attributes[:'nsx_enable_spec']
      end
    ...
    def list_invalid_properties
      ...
      if @master_management_network.nil?
        invalid_properties.push('invalid value for "master_management_network", master_management_network cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @master_management_network.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          master_dns_names == o.master_dns_names &&
          ...
          master_management_network == o.master_management_network &&
          ...
          nsx_deployment == o.nsx_deployment &&
          nsx_enable_spec == o.nsx_enable_spec &&
    ...
    def hash
      [master_dns_names, default_image_registry, default_image_repository, default_kubernetes_service_content_library, ephemeral_storage_policy, image_storage, login_banner, master_dns, master_dns_search_domains, master_ntp_servers, master_management_network, master_storage_policy, ncp_cluster_network_spec, network_provider, nsx_deployment, nsx_enable_spec, service_cidr, size_hint, worker_dns].hash
    end
