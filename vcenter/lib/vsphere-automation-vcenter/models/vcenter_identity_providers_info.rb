...
module VSphereAutomation
  module VCenter
    class VcenterIdentityProvidersInfo
    ...
    def self.openapi_types
      {
        ...
        :'is_default' => :'Boolean',
        :'name' => :'String',
        :'oauth2' => :'VcenterIdentityProvidersOauth2Info',
        :'oidc' => :'VcenterIdentityProvidersOidcInfo',
    ...
    def list_invalid_properties
      ...
      if @org_ids.nil?
        invalid_properties.push('invalid value for "org_ids", org_ids cannot be nil.')
      end
