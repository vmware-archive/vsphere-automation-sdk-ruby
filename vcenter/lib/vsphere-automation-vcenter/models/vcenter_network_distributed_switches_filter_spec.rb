...
module VSphereAutomation
  module VCenter
    ...
    def self.attribute_map
      {
        :'clusters' => :'clusters',
        :'connected_to_all_hosts' => :'connected_to_all_hosts',
        :'min_mtu' => :'min_mtu',
    ...
    def self.openapi_types
      {
        ...
        :'connected_to_all_hosts' => :'Boolean',
        :'min_mtu' => :'Integer',
        :'min_version' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'connected_to_all_hosts')
        self.connected_to_all_hosts = attributes[:'connected_to_all_hosts']
      end

      if attributes.has_key?(:'min_mtu')
        self.min_mtu = attributes[:'min_mtu']
      end

      if attributes.has_key?(:'min_version')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          clusters == o.clusters &&
          connected_to_all_hosts == o.connected_to_all_hosts &&
          min_mtu == o.min_mtu &&
    ...
    def hash
      [clusters, connected_to_all_hosts, min_mtu, min_version].hash
    end
