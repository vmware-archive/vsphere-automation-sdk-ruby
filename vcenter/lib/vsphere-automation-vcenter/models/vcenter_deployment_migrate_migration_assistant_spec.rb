...
module VSphereAutomation
  module VCenter
    class VcenterDeploymentMigrateMigrationAssistantSpec
    ...
    def list_invalid_properties
      ...
      if @ssl_thumbprint.nil?
        invalid_properties.push('invalid value for "ssl_thumbprint", ssl_thumbprint cannot be nil.')
      end
    ...
    def valid?
      return false if @ssl_thumbprint.nil?
      true
    end
    ...
    def hash
      [https_port, ssl_thumbprint].hash
    end
