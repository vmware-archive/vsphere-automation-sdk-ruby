...
module VSphereAutomation
  module VCenter
    class VcenterNamespaceManagementClustersNetworkSpec
    ...
    def self.openapi_types
      {
        :'address_range' => :'VcenterNamespaceManagementClustersIpv4Range',
        :'floating_ip' => :'String',
        :'mode' => :'VcenterNamespaceManagementClustersNetworkSpecIpv4Mode',
        :'network' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'address_range')
    ...
    def hash
      [address_range, floating_ip, mode, network].hash
    end
