...
module VSphereAutomation
  module VCenter
    class VcenterTrustedInfrastructureTrustAuthorityClustersKmsProvidersCurrentPeerCertificatesFilterSpec
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'server_names')
        if (value = attributes[:'server_names']).is_a?(Array)
          self.server_names = value
        end
      end

      if attributes.has_key?(:'trusted')
