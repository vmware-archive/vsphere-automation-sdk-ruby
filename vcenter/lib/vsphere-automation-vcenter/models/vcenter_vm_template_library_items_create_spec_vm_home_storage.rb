...
module VSphereAutomation
  module VCenter
    class VcenterVmTemplateLibraryItemsCreateSpecVmHomeStorage
    ...
    def self.openapi_types
      {
        :'datastore' => :'String',
        :'storage_policy' => :'VcenterVmTemplateLibraryItemsCreateSpecVmHomeStoragePolicy'
      }
    end
