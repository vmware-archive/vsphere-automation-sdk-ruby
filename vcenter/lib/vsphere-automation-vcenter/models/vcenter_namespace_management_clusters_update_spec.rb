...
module VSphereAutomation
  module VCenter
    class VcenterNamespaceManagementClustersUpdateSpec
    ...
    def self.openapi_types
      {
        ...
        :'ncp_cluster_network_spec' => :'VcenterNamespaceManagementClustersNCPClusterNetworkUpdateSpec',
    ...
    def hash
      [default_image_registry, default_image_repository, default_kubernetes_service_content_library, ephemeral_storage_policy, image_storage, login_banner, master_dns, master_dns_search_domains, master_ntp_servers, master_storage_policy, ncp_cluster_network_spec, network_provider, size_hint, tls_endpoint_certificate, worker_dns].hash
    end
