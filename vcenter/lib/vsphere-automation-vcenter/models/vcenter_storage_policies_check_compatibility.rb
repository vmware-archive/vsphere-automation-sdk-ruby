...
module VSphereAutomation
  module VCenter
    class VcenterStoragePoliciesCheckCompatibility
    ...
    def list_invalid_properties
      ...
      if @datastores.nil?
        invalid_properties.push('invalid value for "datastores", datastores cannot be nil.')
      end
    ...
    def valid?
      return false if @datastores.nil?
      true
    end
