...
module VSphereAutomation
  module VCenter
    class VcenterLcmUpdatePendingListResult
    ...
    def self.openapi_types
      {
        :'issues' => :'VcenterLcmNotifications',
        :'last_check_time' => :'DateTime',
        :'update_count' => :'Integer',
        :'updates' => :'Array<VcenterLcmUpdatePendingSummary>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'update_count')
      ...
      if attributes.has_key?(:'upgrade_count')
        self.upgrade_count = attributes[:'upgrade_count']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @last_check_time.nil?
        invalid_properties.push('invalid value for "last_check_time", last_check_time cannot be nil.')
      end
    ...
    def hash
      [issues, last_check_time, update_count, updates, upgrade_count].hash
    end
