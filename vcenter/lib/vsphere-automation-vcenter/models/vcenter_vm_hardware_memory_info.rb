...
module VSphereAutomation
  module VCenter
    ...
    attr_accessor :hot_add_increment_size_mi_b
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hot_add_increment_size_MiB')
        self.hot_add_increment_size_mi_b = attributes[:'hot_add_increment_size_MiB']
      end
