...
module VSphereAutomation
  module VCenter
    class VcenterNamespacesUserInstancesSummary
    # IP address or FQDN of the API endpoint for the given namespace.
    attr_accessor :master_host
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'master_host')
        self.master_host = attributes[:'master_host']
      end
    ...
    def list_invalid_properties
      ...
      if @master_host.nil?
        invalid_properties.push('invalid value for "master_host", master_host cannot be nil.')
      end
    ...
    def valid?
      return false if @master_host.nil?
