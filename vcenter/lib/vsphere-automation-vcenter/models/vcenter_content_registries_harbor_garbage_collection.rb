...
module VSphereAutomation
  module VCenter
    class VcenterContentRegistriesHarborGarbageCollection
    ...
    def self.openapi_types
      {
        :'day_of_week' => :'VcenterContentRegistriesDayOfWeek',
        :'hour' => :'Integer',
        :'minute' => :'Integer',
        :'type' => :'VcenterContentRegistriesRecurrence'
      }
    end
    ...
    def hash
      [day_of_week, hour, minute, type].hash
    end
