...
module VSphereAutomation
  module VCenter
    ...
    # The total size of the data in bytes that can be used by this data set. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. If set, the value is changed.
    attr_accessor :size
    ...
    def hash
      [description, disk_mode, guest, host, size].hash
    end
