...
module VSphereAutomation
  module VCenter
    class VcenterNamespaceManagementClustersImageStorageSpec
    ...
    def list_invalid_properties
      ...
      if @storage_policy.nil?
        invalid_properties.push('invalid value for "storage_policy", storage_policy cannot be nil.')
      end
    ...
    def valid?
      return false if @storage_policy.nil?
      true
    end
