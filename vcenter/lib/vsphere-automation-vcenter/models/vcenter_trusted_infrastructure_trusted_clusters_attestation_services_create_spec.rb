...
module VSphereAutomation
  module VCenter
    class VcenterTrustedInfrastructureTrustedClustersAttestationServicesCreateSpec
    ...
    def self.openapi_types
      {
        ...
        :'type' => :'VcenterTrustedInfrastructureTrustedClustersAttestationServicesCreateSpecSourceType'
      }
    end
    ...
    def hash
      [service, trust_authority_cluster, type].hash
    end
