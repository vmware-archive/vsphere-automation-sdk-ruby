...
module VSphereAutomation
  module VCenter
    class VcenterHvcLinksSyncProvidersSessionInfo
    ...
    def self.openapi_types
      {
        ...
        :'exception' => :'VapiStdLocalizableMessage',
        :'stage' => :'VcenterHvcLinksSyncProvidersSessionInfoStage',
        :'start_time' => :'DateTime',
        :'total_work' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'completed_work')
        self.completed_work = attributes[:'completed_work']
      end
      ...
      if attributes.has_key?(:'total_work')
    ...
    def list_invalid_properties
      ...
      if @completed_work.nil?
        invalid_properties.push('invalid value for "completed_work", completed_work cannot be nil.')
      end
    ...
    def valid?
      return false if @completed_work.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          completed_work == o.completed_work &&
    ...
    def hash
      [completed_work, completion_time, exception, stage, start_time, total_work].hash
    end
