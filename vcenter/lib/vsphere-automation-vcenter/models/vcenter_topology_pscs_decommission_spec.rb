...
module VSphereAutomation
  module VCenter
    class VcenterTopologyPscsDecommissionSpec
    ...
    # SHA1 thumbprint of the external Platform Services Controller node to be decommissioned that will be used for verification.
    ...
    def hash
      [sso_admin_username, sso_admin_password, ssl_thumbprint, ssl_verify].hash
    end
