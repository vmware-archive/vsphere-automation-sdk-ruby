...
module VSphereAutomation
  module VCenter
    class VcenterDeploymentInstallPscSpec
    attr_accessor :standalone

    attr_accessor :replicated

    # Customer experience improvement program should be enabled or disabled.
    ...
    def self.openapi_types
      {
        :'standalone' => :'VcenterDeploymentStandalonePscSpec',
        :'replicated' => :'VcenterDeploymentReplicatedPscSpec',
    ...
    def list_invalid_properties
      ...
      if @ceip_enabled.nil?
        invalid_properties.push('invalid value for "ceip_enabled", ceip_enabled cannot be nil.')
      end
    ...
    def valid?
      return false if @ceip_enabled.nil?
      true
    end
