...
module VSphereAutomation
  module VCenter
    class VcenterNsxDeploymentInstallInstallSpec
    ...
    def list_invalid_properties
      ...
      if @appliance.nil?
        invalid_properties.push('invalid value for "appliance", appliance cannot be nil.')
      end
    ...
    def hash
      [appliance, placement, policy].hash
    end
