...
module VSphereAutomation
  module VCenter
    class VcenterVmLibraryItemCheckOutInfo
    ...
    def list_invalid_properties
      ...
      if @library_item.nil?
        invalid_properties.push('invalid value for "library_item", library_item cannot be nil.')
      end
    ...
    def valid?
      return false if @library_item.nil?
      true
    end
