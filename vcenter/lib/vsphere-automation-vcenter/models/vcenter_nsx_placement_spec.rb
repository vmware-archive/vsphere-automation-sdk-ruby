...
module VSphereAutomation
  module VCenter
    ...
    attr_accessor :create_resource_pool
    ...
    def self.attribute_map
      {
        :'create_resource_pool' => :'create_resource_pool',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'create_resource_pool')
        self.create_resource_pool = attributes[:'create_resource_pool']
      end
    ...
    def list_invalid_properties
      ...
      if @create_resource_pool.nil?
        invalid_properties.push('invalid value for "create_resource_pool", create_resource_pool cannot be nil.')
      end
    ...
    def valid?
      return false if @create_resource_pool.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          create_resource_pool == o.create_resource_pool &&
    ...
    def hash
      [create_resource_pool, resource_pool, resource_pool_name].hash
    end
