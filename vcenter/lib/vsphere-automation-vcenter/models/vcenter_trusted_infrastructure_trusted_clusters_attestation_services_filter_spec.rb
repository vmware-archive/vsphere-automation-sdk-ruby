...
module VSphereAutomation
  module VCenter
    class VcenterTrustedInfrastructureTrustedClustersAttestationServicesFilterSpec
    ...
    def self.openapi_types
      {
        ...
        :'trust_authority_cluster' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'trust_authority_cluster')
        if (value = attributes[:'trust_authority_cluster']).is_a?(Array)
          self.trust_authority_cluster = value
        end
      end
    end
    ...
    def hash
      [address, group, services, trust_authority_cluster].hash
    end
