...
module VSphereAutomation
  module VCenter
    class VcenterTrustSubscriptionsCreateSpec
    ...
    def hash
      [content_type, notification_endpoint, query_string, send_results].hash
    end
