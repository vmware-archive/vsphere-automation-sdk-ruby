...
module VSphereAutomation
  module VCenter
    class VcenterVmHardwareDiskBackingSpec
    attr_accessor :type
    ...
    def self.openapi_types
      {
        :'type' => :'VcenterVmHardwareDiskBackingType',
        :'vmdk_file' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vmdk_file')
        self.vmdk_file = attributes[:'vmdk_file']
      end
    end
