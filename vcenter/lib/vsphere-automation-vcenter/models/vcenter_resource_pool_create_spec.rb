...
module VSphereAutomation
  module VCenter
    class VcenterResourcePoolCreateSpec
    ...
    def self.openapi_types
      {
        :'cpu_allocation' => :'VcenterResourcePoolResourceAllocationCreateSpec',
        :'memory_allocation' => :'VcenterResourcePoolResourceAllocationCreateSpec',
        :'name' => :'String',
        :'parent' => :'String'
      }
    end
    ...
    def hash
      [cpu_allocation, memory_allocation, name, parent].hash
    end
