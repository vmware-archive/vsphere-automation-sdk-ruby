...
module VSphereAutomation
  module VCenter
    class VcenterNamespaceManagementSoftwareClustersInfo
    ...
    def self.openapi_types
      {
        ...
        :'messages' => :'Array<VcenterNamespaceManagementSoftwareClustersMessage>',
        :'state' => :'VcenterNamespaceManagementSoftwareClustersState',
        :'upgrade_status' => :'VcenterNamespaceManagementSoftwareClustersUpgradeStatus'
      }
    end
    ...
    def hash
      [available_versions, current_version, last_upgraded_date, messages, state, upgrade_status].hash
    end
