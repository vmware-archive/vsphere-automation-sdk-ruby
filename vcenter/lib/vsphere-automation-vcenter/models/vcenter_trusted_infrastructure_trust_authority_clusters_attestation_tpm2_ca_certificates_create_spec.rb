...
module VSphereAutomation
  module VCenter
    class VcenterTrustedInfrastructureTrustAuthorityClustersAttestationTpm2CaCertificatesCreateSpec
    ...
    def self.openapi_types
      {
        :'cert_chain' => :'VcenterTrustedInfrastructureX509CertChain',
        :'name' => :'String'
      }
    end
