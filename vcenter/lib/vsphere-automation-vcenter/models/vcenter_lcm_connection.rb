...
module VSphereAutomation
  module VCenter
    ...
    # The port number for the ESX/VC. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. If unset, defaults to 443
    attr_accessor :https_port

    # The password of the 'username' on the ESX/VC host. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    attr_accessor :password

    # Thumbprint for SSL verification. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. If Connection.ssl-verify if false, this field is not required
    attr_accessor :ssl_thumbprint

    # A flag to indicate whether the ssl verification is required. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. If Connection.ssl-thumbprint is provided, this field can be omitted If unset, defaults to True
    attr_accessor :ssl_verify

    # A username with administrative privileges on the ESX/VC host. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
