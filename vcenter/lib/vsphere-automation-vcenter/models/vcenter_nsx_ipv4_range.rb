...
module VSphereAutomation
  module VCenter
    ...
    attr_accessor :ending_address

    attr_accessor :size_specifier
    ...
    attr_accessor :starting_address
    ...
    def self.openapi_types
      {
        ...
        :'size_specifier' => :'VcenterNsxIpv4RangeSizeSpecifier',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'address_count')
        self.address_count = attributes[:'address_count']
      end

      if attributes.has_key?(:'ending_address')
        self.ending_address = attributes[:'ending_address']
      end

      if attributes.has_key?(:'size_specifier')
        self.size_specifier = attributes[:'size_specifier']
      end

      if attributes.has_key?(:'starting_address')
        self.starting_address = attributes[:'starting_address']
      end
    ...
    def list_invalid_properties
      ...
      if @size_specifier.nil?
        invalid_properties.push('invalid value for "size_specifier", size_specifier cannot be nil.')
      end

      if @starting_address.nil?
        invalid_properties.push('invalid value for "starting_address", starting_address cannot be nil.')
      end
    ...
    def valid?
      return false if @size_specifier.nil?
      return false if @starting_address.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          address_count == o.address_count &&
          ending_address == o.ending_address &&
          size_specifier == o.size_specifier &&
          starting_address == o.starting_address &&
    ...
    def hash
      [address_count, ending_address, size_specifier, starting_address, subnet_mask].hash
    end
