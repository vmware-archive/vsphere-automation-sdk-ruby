...
module VSphereAutomation
  module VCenter
    class VcenterNamespaceManagementStatsTimeSeriesTimeSeries
    # Counter identifier.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'time_stamps')
        if (value = attributes[:'time_stamps']).is_a?(Array)
          self.time_stamps = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @time_stamps.nil?
        invalid_properties.push('invalid value for "time_stamps", time_stamps cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @time_stamps.nil?
    ...
    def hash
      [counter, time_stamps, values].hash
    end
