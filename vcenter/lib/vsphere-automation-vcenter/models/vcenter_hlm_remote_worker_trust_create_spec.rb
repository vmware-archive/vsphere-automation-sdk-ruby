...
module VSphereAutomation
  module VCenter
    class VcenterHlmRemoteWorkerTrustCreateSpec
    # Domain identifier Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    ...
    # Label of the trust. A non-unique, user-readable label. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    attr_accessor :label

    # List of signing certificate chains. At least one cert chain is required. Private key is not included. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    attr_accessor :signing_cert_chains

    # Type of trust. Hint for the UI to use to be able to distinguish this VC from others. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    attr_accessor :type

    # List of the UPN suffixes used in this trust relationship. Must contain at least one entry for the trusted domain. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    ...
    def self.openapi_types
      {
        ...
        :'label' => :'String',
        :'signing_cert_chains' => :'Array<VcenterHlmRemoteWorkerX509CertChain>',
        :'type' => :'String',
    ...
    def hash
      [domain, group_map, label, signing_cert_chains, type, upn_suffixes].hash
    end
