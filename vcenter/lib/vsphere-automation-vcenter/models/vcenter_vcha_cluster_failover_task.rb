...
module VSphereAutomation
  module VCenter
    class VcenterVchaClusterFailoverTask
    ...
    def list_invalid_properties
      ...
      if @planned.nil?
        invalid_properties.push('invalid value for "planned", planned cannot be nil.')
      end
