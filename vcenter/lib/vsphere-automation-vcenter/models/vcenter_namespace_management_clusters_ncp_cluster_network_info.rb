...
module VSphereAutomation
  module VCenter
    class VcenterNamespaceManagementClustersNCPClusterNetworkInfo
    ...
    def list_invalid_properties
      ...
      if @cluster_distributed_switch.nil?
        invalid_properties.push('invalid value for "cluster_distributed_switch", cluster_distributed_switch cannot be nil.')
      end

      if @default_ingress_tls_certificate.nil?
        invalid_properties.push('invalid value for "default_ingress_tls_certificate", default_ingress_tls_certificate cannot be nil.')
      end
      ...
      if @nsx_edge_cluster.nil?
        invalid_properties.push('invalid value for "nsx_edge_cluster", nsx_edge_cluster cannot be nil.')
      end
    ...
    def valid?
      return false if @cluster_distributed_switch.nil?
      return false if @default_ingress_tls_certificate.nil?
      return false if @egress_cidrs.nil?
      return false if @ingress_cidrs.nil?
      return false if @nsx_edge_cluster.nil?
    ...
    def hash
      [cluster_distributed_switch, default_ingress_tls_certificate, egress_cidrs, ingress_cidrs, nsx_edge_cluster, pod_cidrs].hash
    end
