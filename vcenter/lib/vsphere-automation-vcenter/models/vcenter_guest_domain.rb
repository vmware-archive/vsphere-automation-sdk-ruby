...
module VSphereAutomation
  module VCenter
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'domain_password')
        self.domain_password = attributes[:'domain_password']
      end

      if attributes.has_key?(:'domain_username')
      ...
      if attributes.has_key?(:'workgroup')
        self.workgroup = attributes[:'workgroup']
      end
    end
    ...
    def hash
      [domain, domain_password, domain_username, type, workgroup].hash
    end
