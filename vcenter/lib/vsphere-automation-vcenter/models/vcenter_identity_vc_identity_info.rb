...
module VSphereAutomation
  module VCenter
    class VcenterIdentityVcIdentityInfo
    ...
    # label of for the local trust Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    attr_accessor :label
    ...
    # UPN Suffixes Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    ...
    def hash
      [domain, label, oauth2_response_endpoint, signing_cert_chains, type, upn_suffixes].hash
    end
