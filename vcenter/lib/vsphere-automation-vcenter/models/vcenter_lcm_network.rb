...
module VSphereAutomation
  module VCenter
    ...
    # Gateway of the network. Required for static mode only. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. This field is optional and it is only relevant when the value of TemporaryNetwork.mode is STATIC.
    attr_accessor :gateway

    # Primary network identity. Can be either an IP address or a fully qualified domain name(FQDN). Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. host name may not be applicable
    attr_accessor :hostname

    # Network IP address. Required for static mode only. Warning: This attribute is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented. This field is optional and it is only relevant when the value of TemporaryNetwork.mode is STATIC.
    attr_accessor :ip
    ...
    def self.openapi_types
      {
        ...
        :'hostname' => :'String',
        :'ip' => :'String',
        :'ip_family' => :'VcenterLcmTemporaryNetworkIpType',
        :'mode' => :'VcenterLcmTemporaryNetworkNetworkMode',
        :'prefix' => :'Integer'
      }
    end
    ...
    def hash
      [dns_servers, gateway, hostname, ip, ip_family, mode, prefix].hash
    end
