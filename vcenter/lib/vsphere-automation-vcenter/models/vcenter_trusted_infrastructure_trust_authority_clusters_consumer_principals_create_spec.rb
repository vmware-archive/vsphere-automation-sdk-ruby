...
module VSphereAutomation
  module VCenter
    class VcenterTrustedInfrastructureTrustAuthorityClustersConsumerPrincipalsCreateSpec
    ...
    def self.openapi_types
      {
        :'certificates' => :'Array<VcenterTrustedInfrastructureX509CertChain>',
        :'issuer' => :'String',
        :'issuer_alias' => :'String',
        :'principal' => :'VcenterTrustedInfrastructureStsPrincipal'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'issuer_alias')
        self.issuer_alias = attributes[:'issuer_alias']
      end
    ...
    def list_invalid_properties
      ...
      if @issuer_alias.nil?
        invalid_properties.push('invalid value for "issuer_alias", issuer_alias cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @issuer_alias.nil?
    ...
    def hash
      [certificates, issuer, issuer_alias, principal].hash
    end
