...
module VSphereAutomation
  ...
  class OvfCapabilityApi
    ...
    # @param server_guid Target vCenter server GUID
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterOvfCapabilityResult, Fixnum, Hash)>] VcenterOvfCapabilityResult data, response status code and response headers
    def get_with_http_info(server_guid, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VCenter::VcenterOvfCapabilityResult')
      if @api_client.config.debugging
