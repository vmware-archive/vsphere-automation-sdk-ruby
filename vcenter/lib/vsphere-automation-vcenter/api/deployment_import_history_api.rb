...
module VSphereAutomation
  ...
  class DeploymentImportHistoryApi
    ...
    # Get the current status of the vCenter historical data import.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterDeploymentImportHistoryResult, Fixnum, Hash)>] VcenterDeploymentImportHistoryResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterDeploymentImportHistoryResult')
      if @api_client.config.debugging
