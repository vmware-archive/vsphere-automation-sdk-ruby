...
module VSphereAutomation
  ...
  class DeploymentInstallPscStandaloneApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterDeploymentInstallPscStandaloneCheck] :vcenter_deployment_install_psc_standalone_check 
    # @return [Array<(VcenterDeploymentInstallPscStandaloneCheckResult, Fixnum, Hash)>] VcenterDeploymentInstallPscStandaloneCheckResult data, response status code and response headers
    def check_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VCenter::VcenterDeploymentInstallPscStandaloneCheckResult')
      if @api_client.config.debugging
