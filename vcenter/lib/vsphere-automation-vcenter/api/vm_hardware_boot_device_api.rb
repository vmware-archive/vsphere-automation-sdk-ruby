...
module VSphereAutomation
  ...
  class VmHardwareBootDeviceApi
    ...
    # @param vm Virtual machine identifier. The parameter must be an identifier for the resource type: VirtualMachine.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterVmHardwareBootDeviceResult, Fixnum, Hash)>] VcenterVmHardwareBootDeviceResult data, response status code and response headers
    def get_with_http_info(vm, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VCenter::VcenterVmHardwareBootDeviceResult')
      if @api_client.config.debugging
    ...
    def set_with_http_info(vm, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_vm_hardware_boot_device_set'])
      auth_names = []
