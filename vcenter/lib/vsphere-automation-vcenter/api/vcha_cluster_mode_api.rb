...
module VSphereAutomation
  ...
  class VchaClusterModeApi
    ...
    # @param vcenter_vcha_cluster_mode_settask 
    # @param [Hash] opts the optional parameters
    # @return [VcenterVchaClusterModeSettaskResult|VapiStdErrorsErrorError|VapiStdErrorsUnauthorizedError|]
    def settask(vcenter_vcha_cluster_mode_settask, opts = {})
      data, _status_code, _headers = settask_with_http_info(vcenter_vcha_cluster_mode_settask, opts)
      data
    end
    ...
    def settask_with_http_info(vcenter_vcha_cluster_mode_settask, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: VchaClusterModeApi.settask ...'
      end
      # verify the required parameter 'vcenter_vcha_cluster_mode_settask' is set
      if @api_client.config.client_side_validation && vcenter_vcha_cluster_mode_settask.nil?
        fail ArgumentError, "Missing the required parameter 'vcenter_vcha_cluster_mode_settask' when calling VchaClusterModeApi.settask"
      end
      # resource path
      local_var_path = '/vcenter/vcha/cluster/mode'
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(vcenter_vcha_cluster_mode_settask)
      auth_names = []
