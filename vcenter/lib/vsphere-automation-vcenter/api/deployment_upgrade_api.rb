...
module VSphereAutomation
  ...
  class DeploymentUpgradeApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterDeploymentUpgradeCheck] :vcenter_deployment_upgrade_check 
    # @return [Array<(VcenterDeploymentUpgradeCheckResult, Fixnum, Hash)>] VcenterDeploymentUpgradeCheckResult data, response status code and response headers
    def check_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterDeploymentUpgradeCheckResult')
      if @api_client.config.debugging
    ...
    # Get the UpgradeSpec parameters used to configure the ongoing appliance upgrade.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterDeploymentUpgradeResult, Fixnum, Hash)>] VcenterDeploymentUpgradeResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterDeploymentUpgradeResult')
      if @api_client.config.debugging
