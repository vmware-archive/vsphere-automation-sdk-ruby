...
module VSphereAutomation
  ...
  class VchaClusterApi
    ...
    # @param vcenter_vcha_cluster_deploytask 
    # @param [Hash] opts the optional parameters
    # @return [VcenterVchaClusterDeploytaskResult|VapiStdErrorsErrorError|VapiStdErrorsUnauthorizedError|]
    def deploytask(vcenter_vcha_cluster_deploytask, opts = {})
      data, _status_code, _headers = deploytask_with_http_info(vcenter_vcha_cluster_deploytask, opts)
      data
    end
    ...
    def deploytask_with_http_info(vcenter_vcha_cluster_deploytask, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: VchaClusterApi.deploytask ...'
      end
      # verify the required parameter 'vcenter_vcha_cluster_deploytask' is set
      if @api_client.config.client_side_validation && vcenter_vcha_cluster_deploytask.nil?
        fail ArgumentError, "Missing the required parameter 'vcenter_vcha_cluster_deploytask' when calling VchaClusterApi.deploytask"
      end
      # resource path
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(vcenter_vcha_cluster_deploytask)
      auth_names = []
    ...
    # @param vcenter_vcha_cluster_failovertask 
    # @param [Hash] opts the optional parameters
    # @return [VcenterVchaClusterFailovertaskResult|VapiStdErrorsErrorError|VapiStdErrorsUnauthorizedError|]
    def failovertask(vcenter_vcha_cluster_failovertask, opts = {})
      data, _status_code, _headers = failovertask_with_http_info(vcenter_vcha_cluster_failovertask, opts)
      data
    end
    ...
    def failovertask_with_http_info(vcenter_vcha_cluster_failovertask, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: VchaClusterApi.failovertask ...'
      end
      # verify the required parameter 'vcenter_vcha_cluster_failovertask' is set
      if @api_client.config.client_side_validation && vcenter_vcha_cluster_failovertask.nil?
        fail ArgumentError, "Missing the required parameter 'vcenter_vcha_cluster_failovertask' when calling VchaClusterApi.failovertask"
      end
      # resource path
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(vcenter_vcha_cluster_failovertask)
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
    ...
    # @param vcenter_vcha_cluster_undeploytask 
    # @param [Hash] opts the optional parameters
    ...
    def undeploytask(vcenter_vcha_cluster_undeploytask, opts = {})
      data, _status_code, _headers = undeploytask_with_http_info(vcenter_vcha_cluster_undeploytask, opts)
      data
    end
    ...
    def undeploytask_with_http_info(vcenter_vcha_cluster_undeploytask, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: VchaClusterApi.undeploytask ...'
      end
      # verify the required parameter 'vcenter_vcha_cluster_undeploytask' is set
      if @api_client.config.client_side_validation && vcenter_vcha_cluster_undeploytask.nil?
        fail ArgumentError, "Missing the required parameter 'vcenter_vcha_cluster_undeploytask' when calling VchaClusterApi.undeploytask"
      end
      # resource path
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(vcenter_vcha_cluster_undeploytask)
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
