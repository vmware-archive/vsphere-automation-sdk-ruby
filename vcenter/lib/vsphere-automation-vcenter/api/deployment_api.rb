...
module VSphereAutomation
  ...
  class DeploymentApi
    ...
    # Get the current status of the appliance deployment.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterDeploymentResult, Fixnum, Hash)>] VcenterDeploymentResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VCenter::VcenterDeploymentResult')
      if @api_client.config.debugging
