...
module VSphereAutomation
  module VCenter
  class NsxClustersConfigurationApi
    ...
    def disable_with_http_info(cluster, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NsxClustersConfigurationApi.disable ...'
      end
      # verify the required parameter 'cluster' is set
      if @api_client.config.client_side_validation && cluster.nil?
        fail ArgumentError, "Missing the required parameter 'cluster' when calling NsxClustersConfigurationApi.disable"
      end
      # resource path
      local_var_path = '/api/vcenter/nsx/clusters/{cluster}/configuration?action=disable'.sub('{' + 'cluster' + '}', cluster.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NsxClustersConfigurationApi#disable\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def enable_with_http_info(cluster, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NsxClustersConfigurationApi.enable ...'
      end
      # verify the required parameter 'cluster' is set
      if @api_client.config.client_side_validation && cluster.nil?
        fail ArgumentError, "Missing the required parameter 'cluster' when calling NsxClustersConfigurationApi.enable"
      end
      # resource path
      local_var_path = '/api/vcenter/nsx/clusters/{cluster}/configuration?action=enable'.sub('{' + 'cluster' + '}', cluster.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NsxClustersConfigurationApi#enable\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
