...
module VSphereAutomation
  ...
  class VmHardwareDiskApi
    ...
    # @option opts [VcenterVmHardwareDiskCreate] :vcenter_vm_hardware_disk_create 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterVmHardwareDiskCreate] :vcenter_vm_hardware_disk_create 
    # @return [Array<(VcenterVmHardwareDiskCreateResult, Fixnum, Hash)>] VcenterVmHardwareDiskCreateResult data, response status code and response headers
    def create_with_http_info(vm, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_vm_hardware_disk_create'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VCenter::VcenterVmHardwareDiskCreateResult')
      if @api_client.config.debugging
    ...
    # @param disk Virtual disk identifier. The parameter must be an identifier for the resource type: vcenter.vm.hardware.Disk.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterVmHardwareDiskResult, Fixnum, Hash)>] VcenterVmHardwareDiskResult data, response status code and response headers
    def get_with_http_info(vm, disk, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterVmHardwareDiskResult')
      if @api_client.config.debugging
    ...
    # @param vm Virtual machine identifier. The parameter must be an identifier for the resource type: VirtualMachine.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterVmHardwareDiskListResult, Fixnum, Hash)>] VcenterVmHardwareDiskListResult data, response status code and response headers
    def list_with_http_info(vm, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterVmHardwareDiskListResult')
      if @api_client.config.debugging
    ...
    # @param disk Virtual disk identifier. The parameter must be an identifier for the resource type: vcenter.vm.hardware.Disk.
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterVmHardwareDiskUpdate] :vcenter_vm_hardware_disk_update 
    # @return [nil]
    def update(vm, disk, opts = {})
      update_with_http_info(vm, disk, opts)
      nil
    end
    ...
    # @option opts [VcenterVmHardwareDiskUpdate] :vcenter_vm_hardware_disk_update 
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def update_with_http_info(vm, disk, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_vm_hardware_disk_update'])
      auth_names = []
