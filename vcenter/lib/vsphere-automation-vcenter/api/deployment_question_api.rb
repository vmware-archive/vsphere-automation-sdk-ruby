...
module VSphereAutomation
  ...
  class DeploymentQuestionApi
    ...
    def answer_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_deployment_question_answer'])
      auth_names = []
    ...
    # Get the question that was raised during the configuration.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterDeploymentQuestionResult, Fixnum, Hash)>] VcenterDeploymentQuestionResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterDeploymentQuestionResult')
      if @api_client.config.debugging
