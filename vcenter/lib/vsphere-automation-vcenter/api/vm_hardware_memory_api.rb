...
module VSphereAutomation
  ...
  class VmHardwareMemoryApi
    ...
    # @return [VcenterVmHardwareMemoryResp|VapiStdErrorsResourceInaccessibleError|VapiStdErrorsUnauthenticatedError|VapiStdErrorsUnauthorizedError|VapiStdErrorsNotFoundError|VapiStdErrorsServiceUnavailableError|]
    def get(vm, opts = {})
    ...
    # @param vm Virtual machine identifier. The parameter must be an identifier for the resource type: VirtualMachine.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterVmHardwareMemoryResp|VapiStdErrorsResourceInaccessibleError|VapiStdErrorsUnauthenticatedError|VapiStdErrorsUnauthorizedError|VapiStdErrorsNotFoundError|VapiStdErrorsServiceUnavailableError|, Fixnum, Hash)>]  data, response status code and response headers
    def get_with_http_info(vm, opts = {})
      ...
      # resource path
      local_var_path = '/rest/vcenter/vm/{vm}/hardware/memory'.sub('{' + 'vm' + '}', vm.to_s)
	...
	:return_type => {
	  '200' => 'VCenter::VcenterVmHardwareMemoryResp',
    ...
    def update_with_http_info(vm, request_body, opts = {})
      ...
      if @api_client.config.client_side_validation && request_body.nil?
        fail ArgumentError, "Missing the required parameter 'request_body' when calling VmHardwareMemoryApi.update"
      end
      # resource path
      local_var_path = '/rest/vcenter/vm/{vm}/hardware/memory'.sub('{' + 'vm' + '}', vm.to_s)
