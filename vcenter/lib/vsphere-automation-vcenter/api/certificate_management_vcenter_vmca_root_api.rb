...
module VSphereAutomation
  module VCenter
  class CertificateManagementVcenterVmcaRootApi
    ...
    def create_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CertificateManagementVcenterVmcaRootApi.create ...'
      end
      # resource path
      local_var_path = '/rest/vcenter/certificate-management/vcenter/vmca-root'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CertificateManagementVcenterVmcaRootApi#create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
