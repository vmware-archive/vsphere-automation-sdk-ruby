...
module VSphereAutomation
  ...
  class DeploymentInstallInitialConfigRemotePscThumbprintApi
    ...
    def get(spec, opts = {})
      data, _status_code, _headers = get_with_http_info(spec, opts)
      data
    end
    ...
    def get_with_http_info(spec, opts = {})
      ...
      if @api_client.config.client_side_validation && spec.nil?
        fail ArgumentError, "Missing the required parameter 'spec' when calling DeploymentInstallInitialConfigRemotePscThumbprintApi.get"
      end
      # resource path
