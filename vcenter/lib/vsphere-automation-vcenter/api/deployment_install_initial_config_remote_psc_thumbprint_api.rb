...
module VSphereAutomation
  ...
  class DeploymentInstallInitialConfigRemotePscThumbprintApi
    ...
    # Gets the SHA1 thumbprint of the remote PSC.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterDeploymentInstallInitialConfigRemotePscThumbprintResult, Fixnum, Hash)>] VcenterDeploymentInstallInitialConfigRemotePscThumbprintResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VCenter::VcenterDeploymentInstallInitialConfigRemotePscThumbprintResult')
      if @api_client.config.debugging
