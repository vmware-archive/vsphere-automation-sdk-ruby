...
module VSphereAutomation
  ...
  class IsoImageApi
    ...
    def mount(library_item, opts = {})
      data, _status_code, _headers = mount_with_http_info(library_item, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterIsoImageMount] :vcenter_iso_image_mount 
    # @return [Array<(VcenterIsoImageMountResult, Fixnum, Hash)>] VcenterIsoImageMountResult data, response status code and response headers
    def mount_with_http_info(library_item, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_iso_image_mount'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VCenter::VcenterIsoImageMountResult')
      if @api_client.config.debugging
    ...
    # @return [nil]
    def unmount(vm, opts = {})
      unmount_with_http_info(vm, opts)
      nil
    end
    ...
    def unmount_with_http_info(vm, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_iso_image_unmount'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
