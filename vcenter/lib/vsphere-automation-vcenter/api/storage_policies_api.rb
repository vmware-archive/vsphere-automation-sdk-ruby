...
module VSphereAutomation
  ...
  class StoragePoliciesApi
    ...
    def check_compatibility(policy, opts = {})
      data, _status_code, _headers = check_compatibility_with_http_info(policy, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterStoragePoliciesCheckCompatibility] :vcenter_storage_policies_check_compatibility 
    # @return [Array<(VcenterStoragePoliciesCheckCompatibilityResult, Fixnum, Hash)>] VcenterStoragePoliciesCheckCompatibilityResult data, response status code and response headers
    def check_compatibility_with_http_info(policy, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_storage_policies_check_compatibility'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VCenter::VcenterStoragePoliciesCheckCompatibilityResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :filter_policies Identifiers of storage policies that can match the filter. If unset or empty, storage policies with any identifiers match the filter. When clients pass a value of this structure as a parameter, the field must contain identifiers for the resource type: vcenter.StoragePolicy. When operations return a value of this structure as a result, the field will contain identifiers for the resource type: com.vmware.vcenter.StoragePolicy.
    # @return [Array<(VcenterStoragePoliciesListResult, Fixnum, Hash)>] VcenterStoragePoliciesListResult data, response status code and response headers
    def list_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterStoragePoliciesListResult')
      if @api_client.config.debugging
