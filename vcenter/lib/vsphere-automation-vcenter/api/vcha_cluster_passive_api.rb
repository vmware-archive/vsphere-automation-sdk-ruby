...
module VSphereAutomation
  ...
  class VchaClusterPassiveApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterVchaClusterPassiveCheck] :vcenter_vcha_cluster_passive_check 
    # @return [Array<(VcenterVchaClusterPassiveCheckResult, Fixnum, Hash)>] VcenterVchaClusterPassiveCheckResult data, response status code and response headers
    def check_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VCenter::VcenterVchaClusterPassiveCheckResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterVchaClusterPassiveRedeploytask] :vcenter_vcha_cluster_passive_redeploytask 
    # @return [Array<(VcenterVchaClusterPassiveRedeploytaskResult, Fixnum, Hash)>] VcenterVchaClusterPassiveRedeploytaskResult data, response status code and response headers
    def redeploytask_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterVchaClusterPassiveRedeploytaskResult')
      if @api_client.config.debugging
