...
module VSphereAutomation
  ...
  class VchaClusterPassiveApi
    ...
    # @param vcenter_vcha_cluster_passive_redeploytask 
    # @param [Hash] opts the optional parameters
    # @return [VcenterVchaClusterPassiveRedeploytaskResult|VapiStdErrorsErrorError|VapiStdErrorsUnauthorizedError|]
    def redeploytask(vcenter_vcha_cluster_passive_redeploytask, opts = {})
      data, _status_code, _headers = redeploytask_with_http_info(vcenter_vcha_cluster_passive_redeploytask, opts)
      data
    end
    ...
    def redeploytask_with_http_info(vcenter_vcha_cluster_passive_redeploytask, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: VchaClusterPassiveApi.redeploytask ...'
      end
      # verify the required parameter 'vcenter_vcha_cluster_passive_redeploytask' is set
      if @api_client.config.client_side_validation && vcenter_vcha_cluster_passive_redeploytask.nil?
        fail ArgumentError, "Missing the required parameter 'vcenter_vcha_cluster_passive_redeploytask' when calling VchaClusterPassiveApi.redeploytask"
      end
      # resource path
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(vcenter_vcha_cluster_passive_redeploytask)
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
