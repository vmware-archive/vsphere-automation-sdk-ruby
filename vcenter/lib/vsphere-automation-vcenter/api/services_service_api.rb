...
module VSphereAutomation
  ...
  class ServicesServiceApi
    ...
    # @param service identifier of the service whose state is being queried.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterServicesServiceResult, Fixnum, Hash)>] VcenterServicesServiceResult data, response status code and response headers
    def get_with_http_info(service, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VCenter::VcenterServicesServiceResult')
      if @api_client.config.debugging
    ...
    # Lists details of vCenter services.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterServicesServiceListDetailsResult, Fixnum, Hash)>] VcenterServicesServiceListDetailsResult data, response status code and response headers
    def list_details_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterServicesServiceListDetailsResult')
      if @api_client.config.debugging
