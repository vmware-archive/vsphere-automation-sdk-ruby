...
module VSphereAutomation
  ...
  class VmHardwareApi
    ...
    # @param vm Virtual machine identifier. The parameter must be an identifier for the resource type: VirtualMachine.
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterVmHardwareUpdate] :vcenter_vm_hardware_update 
    ...
    def update_with_http_info(vm, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_vm_hardware_update'])
      auth_names = []
    ...
    # @param vm Virtual machine identifier. The parameter must be an identifier for the resource type: VirtualMachine.
    # @param vcenter_vm_hardware_upgrade 
    # @param [Hash] opts the optional parameters
    # @return [|VapiStdErrorsResourceInaccessibleError|VapiStdErrorsUnauthenticatedError|VapiStdErrorsUnauthorizedError|VapiStdErrorsNotFoundError|VapiStdErrorsServiceUnavailableError|nil]
    def upgrade(vm, vcenter_vm_hardware_upgrade, opts = {})
      upgrade_with_http_info(vm, vcenter_vm_hardware_upgrade, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(|VapiStdErrorsResourceInaccessibleError|VapiStdErrorsUnauthenticatedError|VapiStdErrorsUnauthorizedError|VapiStdErrorsNotFoundError|VapiStdErrorsServiceUnavailableError|nil, Fixnum, Hash)>] nil, response status code and response headers
    def upgrade_with_http_info(vm, vcenter_vm_hardware_upgrade, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'vcenter_vm_hardware_upgrade' is set
      if @api_client.config.client_side_validation && vcenter_vm_hardware_upgrade.nil?
        fail ArgumentError, "Missing the required parameter 'vcenter_vm_hardware_upgrade' when calling VmHardwareApi.upgrade"
      end
      # resource path
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(vcenter_vm_hardware_upgrade)
      auth_names = []
