...
module VSphereAutomation
  ...
  class VmHardwareFloppyApi
    ...
    # @param vm Virtual machine identifier. The parameter must be an identifier for the resource type: VirtualMachine.
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterVmHardwareFloppyCreate] :vcenter_vm_hardware_floppy_create 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterVmHardwareFloppyCreate] :vcenter_vm_hardware_floppy_create 
    # @return [Array<(VcenterVmHardwareFloppyCreateResult, Fixnum, Hash)>] VcenterVmHardwareFloppyCreateResult data, response status code and response headers
    def create_with_http_info(vm, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_vm_hardware_floppy_create'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterVmHardwareFloppyCreateResult')
      if @api_client.config.debugging
    ...
    # @param floppy Virtual floppy drive identifier. The parameter must be an identifier for the resource type: vcenter.vm.hardware.Floppy.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterVmHardwareFloppyResult, Fixnum, Hash)>] VcenterVmHardwareFloppyResult data, response status code and response headers
    def get_with_http_info(vm, floppy, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterVmHardwareFloppyResult')
      if @api_client.config.debugging
    ...
    # @param vm Virtual machine identifier. The parameter must be an identifier for the resource type: VirtualMachine.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterVmHardwareFloppyListResult, Fixnum, Hash)>] VcenterVmHardwareFloppyListResult data, response status code and response headers
    def list_with_http_info(vm, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterVmHardwareFloppyListResult')
      if @api_client.config.debugging
    ...
    # @param floppy Virtual floppy drive identifier. The parameter must be an identifier for the resource type: vcenter.vm.hardware.Floppy.
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterVmHardwareFloppyUpdate] :vcenter_vm_hardware_floppy_update 
    # @return [nil]
    def update(vm, floppy, opts = {})
      update_with_http_info(vm, floppy, opts)
      nil
    end
    ...
    # @option opts [VcenterVmHardwareFloppyUpdate] :vcenter_vm_hardware_floppy_update 
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def update_with_http_info(vm, floppy, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_vm_hardware_floppy_update'])
      auth_names = []
