...
module VSphereAutomation
  ...
  class InventoryDatastoreApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterInventoryDatastoreFind] :vcenter_inventory_datastore_find 
    # @return [Array<(VcenterInventoryDatastoreFindResult, Fixnum, Hash)>] VcenterInventoryDatastoreFindResult data, response status code and response headers
    def find_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_inventory_datastore_find'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VCenter::VcenterInventoryDatastoreFindResult')
      if @api_client.config.debugging
