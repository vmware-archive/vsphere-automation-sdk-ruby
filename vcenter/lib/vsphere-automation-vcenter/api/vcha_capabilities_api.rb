...
module VSphereAutomation
  ...
  class VchaCapabilitiesApi
    ...
    # Gets the capabilities of the active node of a VCHA cluster.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterVchaCapabilitiesResult, Fixnum, Hash)>] VcenterVchaCapabilitiesResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VCenter::VcenterVchaCapabilitiesResult')
      if @api_client.config.debugging
