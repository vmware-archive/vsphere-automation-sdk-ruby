...
module VSphereAutomation
  ...
  class OvfLibraryItemApi
    ...
    # @option opts [VcenterOvfLibraryItemCreate] :vcenter_ovf_library_item_create 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterOvfLibraryItemCreate] :vcenter_ovf_library_item_create 
    # @return [Array<(VcenterOvfLibraryItemCreateResult, Fixnum, Hash)>] VcenterOvfLibraryItemCreateResult data, response status code and response headers
    def create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_ovf_library_item_create'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VCenter::VcenterOvfLibraryItemCreateResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterOvfLibraryItemDeploy] :vcenter_ovf_library_item_deploy 
    # @return [VcenterOvfLibraryItemDeployResult]
    def deploy(ovf_library_item_id, opts = {})
      data, _status_code, _headers = deploy_with_http_info(ovf_library_item_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterOvfLibraryItemDeploy] :vcenter_ovf_library_item_deploy 
    # @return [Array<(VcenterOvfLibraryItemDeployResult, Fixnum, Hash)>] VcenterOvfLibraryItemDeployResult data, response status code and response headers
    def deploy_with_http_info(ovf_library_item_id, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_ovf_library_item_deploy'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterOvfLibraryItemDeployResult')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterOvfLibraryItemFilter] :vcenter_ovf_library_item_filter 
    # @return [VcenterOvfLibraryItemFilterResult]
    def filter(ovf_library_item_id, opts = {})
      data, _status_code, _headers = filter_with_http_info(ovf_library_item_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterOvfLibraryItemFilter] :vcenter_ovf_library_item_filter 
    # @return [Array<(VcenterOvfLibraryItemFilterResult, Fixnum, Hash)>] VcenterOvfLibraryItemFilterResult data, response status code and response headers
    def filter_with_http_info(ovf_library_item_id, opts = {})
      if @api_client.config.debugging
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_ovf_library_item_filter'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterOvfLibraryItemFilterResult')
      if @api_client.config.debugging
