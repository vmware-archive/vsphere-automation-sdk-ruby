...
module VSphereAutomation
  ...
  class VchaOperationsApi
    ...
    # Retrieves the current active and disabled operations of a VCHA cluster.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterVchaOperationsResult, Fixnum, Hash)>] VcenterVchaOperationsResult data, response status code and response headers
    def get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'VCenter::VcenterVchaOperationsResult')
      if @api_client.config.debugging
