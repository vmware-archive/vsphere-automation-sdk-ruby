...
module VSphereAutomation
  ...
  class VmHardwareSerialApi
    ...
    # @param vm Virtual machine identifier. The parameter must be an identifier for the resource type: VirtualMachine.
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterVmHardwareSerialCreate] :vcenter_vm_hardware_serial_create 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterVmHardwareSerialCreate] :vcenter_vm_hardware_serial_create 
    # @return [Array<(VcenterVmHardwareSerialCreateResult, Fixnum, Hash)>] VcenterVmHardwareSerialCreateResult data, response status code and response headers
    def create_with_http_info(vm, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_vm_hardware_serial_create'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterVmHardwareSerialCreateResult')
      if @api_client.config.debugging
    ...
    # @param port Virtual serial port identifier. The parameter must be an identifier for the resource type: vcenter.vm.hardware.SerialPort.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterVmHardwareSerialResult, Fixnum, Hash)>] VcenterVmHardwareSerialResult data, response status code and response headers
    def get_with_http_info(vm, port, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterVmHardwareSerialResult')
      if @api_client.config.debugging
    ...
    # @param vm Virtual machine identifier. The parameter must be an identifier for the resource type: VirtualMachine.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterVmHardwareSerialListResult, Fixnum, Hash)>] VcenterVmHardwareSerialListResult data, response status code and response headers
    def list_with_http_info(vm, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'VCenter::VcenterVmHardwareSerialListResult')
      if @api_client.config.debugging
    ...
    # @param port Virtual serial port identifier. The parameter must be an identifier for the resource type: vcenter.vm.hardware.SerialPort.
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterVmHardwareSerialUpdate] :vcenter_vm_hardware_serial_update 
    # @return [nil]
    ...
    def update_with_http_info(vm, port, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_vm_hardware_serial_update'])
      auth_names = []
