...
module VSphereAutomation
  ...
  class OvfImportFlagApi
    ...
    # @return [VcenterOvfImportFlagListResp|VapiStdErrorsNotFoundError|]
    def list(rp, opts = {})
    ...
    # @param rp The identifier of resource pool target for retrieving the import flag(s).
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterOvfImportFlagListResp|VapiStdErrorsNotFoundError|, Fixnum, Hash)>]  data, response status code and response headers
    def list_with_http_info(rp, opts = {})
      ...
      # resource path
      local_var_path = '/rest/com/vmware/vcenter/ovf/import-flag'
	...
	:return_type => {
	  '200' => 'VCenter::VcenterOvfImportFlagListResp',
