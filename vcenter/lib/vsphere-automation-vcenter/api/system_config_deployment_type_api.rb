...
module VSphereAutomation
  ...
  class SystemConfigDeploymentTypeApi
    ...
    # @return [VcenterSystemConfigDeploymentTypeResp|VapiStdErrorsNotAllowedInCurrentStateError|VapiStdErrorsUnauthenticatedError|]
    def get(opts = {})
    ...
    # @api private
    # @param [Hash] opts the optional parameters
    # @return [Array<(VcenterSystemConfigDeploymentTypeResp|VapiStdErrorsNotAllowedInCurrentStateError|VapiStdErrorsUnauthenticatedError|, Fixnum, Hash)>]  data, response status code and response headers
    def get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SystemConfigDeploymentTypeApi.get ...'
      end
      # resource path
      local_var_path = '/rest/vcenter/system-config/deployment-type'
	...
	:return_type => {
	  '200' => 'VCenter::VcenterSystemConfigDeploymentTypeResp',
