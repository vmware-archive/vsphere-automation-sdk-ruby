...
module VSphereAutomation
  ...
  class DeploymentInstallRemotePscApi
    ...
    # @option opts [VcenterDeploymentInstallRemotePscCheck] :vcenter_deployment_install_remote_psc_check 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [VcenterDeploymentInstallRemotePscCheck] :vcenter_deployment_install_remote_psc_check 
    # @return [Array<(VcenterDeploymentInstallRemotePscCheckResult, Fixnum, Hash)>] VcenterDeploymentInstallRemotePscCheckResult data, response status code and response headers
    def check_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'vcenter_deployment_install_remote_psc_check'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VCenter::VcenterDeploymentInstallRemotePscCheckResult')
      if @api_client.config.debugging
