...
# Unit tests for VSphereAutomation::VCenter::SystemConfigFeaturesTechPreviewApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SystemConfigFeaturesTechPreviewApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::VCenter::SystemConfigFeaturesTechPreviewApi.new
  end
  ...
  describe 'test an instance of SystemConfigFeaturesTechPreviewApi' do
    it 'should create an instance of SystemConfigFeaturesTechPreviewApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::VCenter::SystemConfigFeaturesTechPreviewApi)
    end
  end
  ...
  # @return [VcenterSystemConfigFeaturesTechPreviewResp]
