...
# Unit tests for VSphereAutomation::VCenter::TagsHostAssociationsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TagsHostAssociationsApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::VCenter::TagsHostAssociationsApi.new
  end
  ...
  describe 'test an instance of TagsHostAssociationsApi' do
    it 'should create an instance of TagsHostAssociationsApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::VCenter::TagsHostAssociationsApi)
    end
  end
  ...
  # @return [VcenterTagsHostAssociationsAddResp]
  ...
  # @param [Hash] opts the optional parameters
  # @return [VcenterTagsHostAssociationsResp]
  ...
  # @param request_body 
  # @param [Hash] opts the optional parameters
  # @return [VcenterTagsHostAssociationsRemoveResp]
