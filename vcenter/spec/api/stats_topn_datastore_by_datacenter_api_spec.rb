...
# Unit tests for VSphereAutomation::VCenter::StatsTopnDatastoreByDatacenterApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StatsTopnDatastoreByDatacenterApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::VCenter::StatsTopnDatastoreByDatacenterApi.new
  end
  ...
  describe 'test an instance of StatsTopnDatastoreByDatacenterApi' do
    it 'should create an instance of StatsTopnDatastoreByDatacenterApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::VCenter::StatsTopnDatastoreByDatacenterApi)
    end
  end
