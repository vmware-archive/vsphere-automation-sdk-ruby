...
# Unit tests for VSphereAutomation::VCenter::StatsTopnResourcechildByClusterApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StatsTopnResourcechildByClusterApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::VCenter::StatsTopnResourcechildByClusterApi.new
  end
  ...
  describe 'test an instance of StatsTopnResourcechildByClusterApi' do
    it 'should create an instance of StatsTopnResourcechildByClusterApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::VCenter::StatsTopnResourcechildByClusterApi)
    end
  end
