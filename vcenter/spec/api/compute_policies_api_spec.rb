...
# Unit tests for VSphereAutomation::VCenter::ComputePoliciesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ComputePoliciesApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::VCenter::ComputePoliciesApi.new
  end
  ...
  describe 'test an instance of ComputePoliciesApi' do
    it 'should create an instance of ComputePoliciesApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::VCenter::ComputePoliciesApi)
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @return [Array<VcenterComputePoliciesSummary>]
