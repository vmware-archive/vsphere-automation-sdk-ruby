...
# Unit tests for VSphereAutomation::VCenter::TagsHostApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TagsHostApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::VCenter::TagsHostApi.new
  end
  ...
  describe 'test an instance of TagsHostApi' do
    it 'should create an instance of TagsHostApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::VCenter::TagsHostApi)
    end
  end
  ...
  # @return [VcenterTagsHostListResp]
