...
# Unit tests for VSphereAutomation::VCenter::HlmRemoteWorkerApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'HlmRemoteWorkerApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::VCenter::HlmRemoteWorkerApi.new
  end
  ...
  describe 'test an instance of HlmRemoteWorkerApi' do
    it 'should create an instance of HlmRemoteWorkerApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::VCenter::HlmRemoteWorkerApi)
    end
  end
