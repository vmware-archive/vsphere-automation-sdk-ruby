...
# Unit tests for VSphereAutomation::VCenter::LcmStatusManagerApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LcmStatusManagerApi' do
  before do
    # run before each test
    @instance = VSphereAutomation::VCenter::LcmStatusManagerApi.new
  end
  ...
  describe 'test an instance of LcmStatusManagerApi' do
    it 'should create an instance of LcmStatusManagerApi' do
      expect(@instance).to be_instance_of(VSphereAutomation::VCenter::LcmStatusManagerApi)
    end
  end
